package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1004:String = "AssetLibraryReady";
      
      public static const const_735:String = "AssetLibraryLoaded";
      
      public static const const_1472:String = "AssetLibraryUnloaded";
      
      public static const const_1260:String = "AssetLibraryLoadError";
      
      private static var var_274:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_460:uint = 0;
      
      private static var var_846:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_848 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_846.splice(var_846.indexOf(this),1);
            --var_460;
            this.var_459 = null;
            this.var_848 = null;
            this.var_142 = null;
      ...
      {
         if(this._file == param1.url && this.var_849)
         {
            if(!this.var_847 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_694,this.var_577);
            }
            this.var_847 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1004));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_848)
         {
            delete this.var_848[_loc1_];
         }
         if(this.var_36 != null)
         {
            this.var_36.dispose();
      ...
      {
         var _loc2_:Class = this.var_848[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_965,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1045,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1106,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_957,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_374;
                     this.var_373.push(struct.assetName);
                  }
      ...
      public function getAssetByName(param1:String) : IAsset
      {
         ...
         return this.method_11(param1);
      }
      
      public function getAssetByIndex(param1:uint) : IAsset
      {
         return param1 < this.var_373.length ? this.getAssetByName(this.var_373[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_142)
         {
            ...
            {
               return this.var_373.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_142[param1] != null || (this.var_577 != null ? this.var_577[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_274.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_274[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_274[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_274)
            {
               _loc3_ = AssetTypeDeclaration(var_274[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_274)
            {
               _loc4_ = AssetTypeDeclaration(var_274[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_849 = true;
         dispatchEvent(new Event(AssetLibrary.const_735));
         dispatchEvent(new Event(AssetLibrary.const_1004));
         if(this.var_847)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1260));
         this.var_36 = null;
      }
      ...
      private function method_11(param1:String) : IAsset
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc5_:* = null;
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_577[param1]);
