package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1539:uint = 1;
      
      protected static const const_1541:uint = 2;
      
      protected static const const_1542:uint = 4;
      
      protected static const const_1540:uint = 3;
      
      protected static const name_2:uint = 7;
      
      public static const const_1432:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_997:Boolean = false;
      
      public static const const_1409:int = 2;
      
      private static var var_861:Array = new Array();
      ...
      protected var var_952:Boolean = false;
      
      protected var var_2679:String = "";
      
      protected var var_2681:String = "";
      
      protected var var_1933:int;
      
      protected var var_1195:int;
      
      protected var var_1194:int;
      
      protected var var_2755:uint = 0;
      
      protected var var_2680:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_36.load(param1.var_216,param1.var_15);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_997)
         {
            ...
            while(var_705.length < const_1409 && false)
            {
               _loc1_ = var_861.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_705.push(_loc1_);
                  _loc1_.var_36.load(_loc1_.var_216,_loc1_.var_15);
               }
            }
         }
      }
      ...
      {
         return !!this.var_953 ? uint(this.var_1195 - this.var_1933) : uint(getTimer() - this.var_1933);
      }
      ...
      {
         if(this.var_952 && !_disposed)
         {
            this.var_952 = false;
            if(!this.var_953 && this.var_216)
            {
               this.var_1195 = -1;
      ...
      {
         if(!this.var_953 && !_disposed && this.var_1194 > 0)
         {
            try
            {
               this.var_36.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_216,const_1432 - this.var_1194);
            if(this.var_2680)
            {
            ...
            --this.var_1194;
            this.var_413 = 0;
            this.var_36.load(this.var_216,this.var_15);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_413 = LibraryLoader.name_2;
         ...
         if(this.var_413 == LibraryLoader.const_1540)
         {
         ...
         if(this.var_413 == LibraryLoader.name_2)
         {
