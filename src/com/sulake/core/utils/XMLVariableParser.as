package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1504:String = "float";
      
      public static const const_46:String = "Boolean";
      
      public static const const_1326:String = "bool";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_239 || _loc5_ == const_143)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1504:
               return Number(param1);
            case const_46:
               return param1 == "ObjectMouseData" || int(param1) > 0;
            case const_1326:
               return param1 == "ObjectMouseData" || int(param1) > 0;
            case const_160:
               return uint(param1);
