package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerAgentTask implements IDisposable
   {
      ...
      public function stop() : void
      {
         if(this.var_678)
         {
            this.var_1700 = getTimer() - this.var_2068;
            ++this.var_1082;
            this.var_1346 += this.var_1700;
            this.var_1701 = this.var_1346 / this.var_1082;
            this.var_678 = false;
         }
      }
