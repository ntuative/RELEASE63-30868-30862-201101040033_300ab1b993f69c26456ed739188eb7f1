package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1239:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1238:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_135:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_135 = this.profiler;
         this._windowManager = param2;
         this.var_893 = param3;
         var _loc4_:ByteArray = new var_1239() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_135)
         {
            this.var_135.removeStopEventListener(this.refresh);
            this.var_135 = null;
         }
         if(!this.var_135 && param1)
         {
            this.var_135 = param1;
            this.var_135.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_564)
            {
               this.var_1519 = false;
               ITextWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_135.getProfilerAgentsInArray();
         ...
         if(this.var_1519)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_135.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_135.numBitmapAssetInstances + " / " + this.var_135.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_893.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_135.numTrackedBitmapDataInstances + " / " + this.var_135.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1238() as ByteArray;
