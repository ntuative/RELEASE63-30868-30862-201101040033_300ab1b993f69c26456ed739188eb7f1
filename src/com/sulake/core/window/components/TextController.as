package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1535:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1536:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
       
      
      protected var _field:TextField;
      
      protected var var_771:Number;
      
      protected var var_510:Number;
      
      protected var var_511:Boolean;
      
      protected var var_76:TextMargins;
      
      protected var var_412:String = "none";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_76 = new TextMargins(0,0,0,0,this.setTextMargins);
         this.var_511 = false;
         this.var_771 = 0;
         this.var_510 = 0;
         if(this._field == null)
         ...
         setTextFormatting(this._field,this.var_366,this.var_194);
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_114)
         {
            param1.context.removeLocalizationListener(param1.var_37,param1);
            param1.var_114 = false;
         }
         param1.var_37 = param2;
         if(param1.var_37.charAt(0) == "$" && param1.var_37.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_37.slice(2,param1.var_37.indexOf("}")),param1);
            param1.var_114 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_37;
            param1.refreshTextImage();
         }
      }
      ...
      {
         param1.var_76.dispose();
         param1.var_76 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            ...
            setTextFormatting(param1._field,param1.var_366,param1.var_194);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_380);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1067 ? true : null;
         }
      ...
      {
         this.var_771 = param1;
         this._field.scrollH = this.var_771 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_771 * this.maxScrollH,this.var_510 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_771 = this.var_771;
         _loc1_.var_510 = this.var_510;
         _loc1_.var_76 = this.var_76.clone(_loc1_.setTextMargins);
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_511 = true;
         var _loc2_:int = this.var_76.left + this.var_76.right;
         var _loc3_:int = this.var_76.top + this.var_76.bottom;
         ...
         if(_loc6_ != _loc4_)
         {
            if(this.var_412 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
            else if(this.var_412 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
            else if(this.var_412 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_412 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc6_ + _loc2_,Math.floor(this._field.height) + _loc3_);
               _loc7_ = true;
            }
         ...
         this.var_511 = false;
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_75);
         if(!_loc7_ && !param1)
         {
      ...
      {
         if(param1 != this.var_76)
         {
            this.var_76.dispose();
            this.var_76 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,this.setTextMargins);
         }
         this.refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_265,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_160,this._field.textColor != _loc2_.color));
         ...
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_46,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_46,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_160,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_46,this._field.condenseWhite != false));
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_84,this._field.gridFitType != GridFitType.PIXEL,const_1535));
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_51,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",this._field.mouseWheelEnabled,PropertyStruct.const_46,this._field.mouseWheelEnabled != false));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_46,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_84,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_226,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_366,PropertyStruct.const_84,this.var_366 != TextStyleManager.const_380,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_226,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_46,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_76.left,PropertyStruct.const_51,this.var_76.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_76.top,PropertyStruct.const_51,this.var_76.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_76.right,PropertyStruct.const_51,this.var_76.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_76.bottom,PropertyStruct.const_51,this.var_76.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_412,PropertyStruct.const_84,this.var_412 != TextFieldAutoSize.NONE,const_1536));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_46,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_46,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_46,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_46,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_226,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
