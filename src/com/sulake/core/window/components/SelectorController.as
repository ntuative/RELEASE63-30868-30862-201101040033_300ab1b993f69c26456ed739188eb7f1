package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_175:ISelectableWindow;
      ...
      {
         return this.var_175 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_175)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_313,this,this.var_175));
               }
            }
         }
      }
