package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1162:String = "_SELECTOR";
      
      private static const const_1161:String = "_CONTENT";
       
      
      protected var var_947:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_947 = findChildByTag(const_1162) as ITabSelectorWindow;
            if(this.var_947 != null)
            {
               this.var_947.procedure = this.selectorEventProc;
            }
         }
         return this.var_947;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1928 = findChildByTag(const_1161) as IWindowContainer;
         }
      ...
      {
         return !!this.var_755 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_947.numSelectables;
      }
