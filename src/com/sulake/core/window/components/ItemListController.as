package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1128:String = "spacing";
      
      protected static const const_1126:String = "scale_to_fit_items";
      
      protected static const const_1127:String = "resize_on_item_update";
      
      protected static const const_1129:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1544:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1543:Boolean = true;
      ...
      protected var var_1936:Boolean = false;
      ...
      protected var var_954:Boolean = true;
      
      protected var var_513:Boolean = false;
      
      protected var var_1200:Boolean = false;
      
      protected var var_1935:int = 0;
      
      protected var var_1937:int = 0;
      
      protected var var_1197:Number;
      
      protected var var_1198:Number;
      
      protected var var_1199:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_99 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_325;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_153 = var_418 || !testParamFlag(WindowParam.const_32);
         this._container = var_15.create("_CONTAINER","",WindowType.const_373,WindowStyle.const_781,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_285,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_442,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1200;
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_629)
         {
            ...
            var_15.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_75);
            dispatchEvent(new WindowEvent(WindowEvent.const_510,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_460,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_285,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_170:
               if(this.var_1199)
               {
                  this.var_1197 = this.var_1935 - _loc3_;
                  this.var_1198 = this.var_1937 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1198 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1198 / this.var_90;
                  }
                  this.var_1935 = _loc3_;
                  this.var_1937 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_231:
               if(this.var_1199)
               {
                  ...
                  {
                     var_15.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1198);
                  }
                  this.var_1199 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_954 && !this.var_512 && this._container)
         {
            this.var_512 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1128,this._spacing,PropertyStruct.const_51,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1129,this.var_954,PropertyStruct.const_46,this.var_954 != const_1543));
         _loc1_.push(new PropertyStruct(const_1126,this.var_513,PropertyStruct.const_46,this.var_513 != const_1544));
         _loc1_.push(new PropertyStruct(const_1127,this.var_1200,PropertyStruct.const_46,this.var_1200 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1127:
                  ...
                  break;
               case const_1129:
                  this.var_954 = _loc2_.value as Boolean;
                  break;
            }
         }
