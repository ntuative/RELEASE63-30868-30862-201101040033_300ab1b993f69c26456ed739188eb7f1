package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1196:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_20)
         {
            var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_960,var_11);
         }
         return var_20;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_431)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_755 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_15.handleError(WindowContext.const_334,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1196,PropertyStruct.const_46,this.var_1196 != false));
         _loc1_.push(new PropertyStruct("selectable",_field.selectable,PropertyStruct.const_46,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_46,true));
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_1196 = _loc2_.value as Boolean;
               if(this.var_1196)
               {
