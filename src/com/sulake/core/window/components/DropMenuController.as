package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1123:String = "_DROPMENU_ITEMLIST";
      
      protected static const const_1124:String = "item_array";
      ...
      private var var_155:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_486,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_530 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_313,this,null));
         }
      }
      ...
      {
         if(this.var_155 != null && !this.var_155.disposed)
         {
            this.var_155.destroy();
            this.var_155 = null;
         }
         super.dispose();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_155 == null || this.var_155.disposed)
         {
            this.var_155 = context.create(name + "::submenu","",WindowType.const_520,var_78,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_155.setGlobalRectangle(_loc1_);
         }
         this.var_155.activate();
         return this.var_155;
      }
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1123) as IItemListWindow;
         if(_loc3_ != null)
         {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_155.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_792 = false;
            this.getTitleText().text = this.var_530 < this._itemArray.length && this.var_530 > -1 ? this._itemArray[this.var_530] : caption;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1123) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_429,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_373,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_530 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_530).setStateFlag(WindowState.const_50,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_40 || param1.type == WindowTouchEvent.const_431)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_993:
            case WindowMouseEvent.const_60:
               ...
               break;
            case WindowTouchEvent.const_582:
            case WindowMouseEvent.const_40:
               ...
               break;
            case WindowEvent.const_755:
               if(param2 == this.var_155)
               {
                  this.closeMenuView();
               }
         }
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_1119;
         this.update(this,_loc1_);
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1124,this._itemArray,PropertyStruct.const_143,this._itemArray.length > 0));
         return _loc1_;
      }
