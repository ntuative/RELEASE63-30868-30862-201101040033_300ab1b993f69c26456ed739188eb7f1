package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1178:String = "_CONTROLS";
      ...
      {
         return findChildByTag(const_1140) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(const_1178) as IItemListWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1133,_loc2_,true);
