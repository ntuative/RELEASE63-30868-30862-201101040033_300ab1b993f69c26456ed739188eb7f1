package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1175:String = "decrement";
      
      private static const const_837:String = "slider_track";
      
      private static const const_545:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_153 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_499;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_510,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_510,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_837) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_545) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_545:
         ...
         if(param2.type == WindowNotifyEvent.const_416)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.include)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_40 || param1.type == WindowTouchEvent.const_431)
         {
            ...
            else if(param2.name == const_1175)
            {
               if(this.var_18)
               {
                  this.var_1005 = true;
            ...
            else if(param2.name == const_837)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_545).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.include)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(this.var_822 != null)
         {
            ...
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_822) as IScrollableWindow;
               if(_loc1_)
               {
