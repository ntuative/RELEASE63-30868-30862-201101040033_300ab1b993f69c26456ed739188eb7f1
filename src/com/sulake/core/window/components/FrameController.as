package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1140:String = "_TITLE";
      
      private static const const_1141:String = "_HEADER";
      
      private static const const_1138:String = "_CONTENT";
      
      private static const const_1139:String = "_SCALER";
      
      private static const const_827:String = "margin_left";
      
      private static const const_826:String = "margin_top";
      
      private static const const_825:String = "margin_right";
      ...
      private var var_1217:IHeaderWindow;
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1140) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1217 = findChildByTag(const_1141) as IHeaderWindow;
            if(!this.var_1217)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_162 = findChildByTag(const_1138) as IWindowContainer;
            if(!this.var_162)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1133,_loc2_,false);
      ...
      {
         return this.content != null && this.var_953 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_262);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_253);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_301,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_827,_loc3_.left,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_826,_loc3_.top,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_825,0 - _loc3_.right,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_824,0 - _loc3_.bottom,PropertyStruct.const_51,_loc2_));
         return _loc1_;
      }
