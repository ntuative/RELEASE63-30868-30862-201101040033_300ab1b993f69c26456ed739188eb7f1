package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1699:String = "_INCLUDE";
      
      public static const const_1655:String = "_TEMP";
      
      private static const const_1166:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1167:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var _typeStringToCodeTable:Dictionary;
      
      protected var var_1184:Dictionary;
      
      protected var var_948:Dictionary;
      
      protected var var_1445:Dictionary;
      
      protected var var_1929:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1184);
         this.var_948 = new Dictionary();
         this.var_1445 = new Dictionary();
         ParamCodeTable.fillTables(this.var_948,this.var_1445);
         this.var_1929 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1167,"");
         return param1.replace(const_1166,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1184)
            {
               delete this.var_1184[_loc1_];
            }
            for(_loc1_ in this.var_948)
            {
               delete this.var_948[_loc1_];
            }
            for(_loc1_ in this.var_1445)
            {
               delete this.var_1445[_loc1_];
            }
            this.var_1929.dispose();
            this.var_1929 = null;
            this.var_15 = null;
            this._disposed = true;
         }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = this.parseAttribute(xml,"visible",variables,visible.toString()) == "ObjectMouseData";
         ...
         background = this.parseAttribute(xml,"background",variables,window.background.toString()) == "ObjectMouseData";
         blend = Number(this.parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "ObjectMouseData";
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_188)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1184[param1.type];
