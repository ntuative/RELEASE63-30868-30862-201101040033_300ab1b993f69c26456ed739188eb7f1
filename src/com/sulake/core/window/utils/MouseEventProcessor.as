package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_151:IWindowRenderer;
      
      protected var var_129:IDesktopWindow;
      
      protected var var_773:IWindowContextStateListener;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_231;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_77 = param1.var_1180 as WindowController;
         this._lastClickTarget = param1.var_1177 as WindowController;
         this.var_151 = param1.renderer;
         this.var_773 = param1.var_1179;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_628.x || _loc3_.stageY != this.var_628.y)
            {
               ...
               _loc6_ = new Array();
               this.var_129.groupParameterFilteredChildrenUnderPoint(this.var_628,_loc6_,WindowParam.const_28);
            }
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_77 && !this.var_77.disposed)
                     {
                        ...
                        {
                           this.var_773.mouseEventReceived(_loc3_.type,this.var_77);
                        }
                     }
                  }
         ...
         param1.var_1180 = this.var_77;
         param1.var_1177 = this._lastClickTarget;
         param1.renderer = this.var_151;
         param1.var_1179 = this.var_773;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_151.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_469))
         {
