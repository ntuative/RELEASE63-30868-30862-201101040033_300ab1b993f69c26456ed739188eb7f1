package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1175:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1133:String = "_COLORIZE";
      
      protected static const const_1548:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1438:Point = new Point();
      ...
      protected var var_631:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_350 = new Rectangle();
         if(_loc12_ != null)
         {
            var_355 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_56 = var_355.clone();
            var_11 = var_355.clone();
         ...
         if(_loc13_)
         {
            var_687 = _loc13_.blend;
            var_419 = _loc13_.treshold;
            if(var_418 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_220 != _loc13_.color)
            {
      ...
      {
         return this.var_631 != null ? this.var_631 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_418 = param1;
         var_220 = !!var_418 ? uint(var_220 | var_515) : uint(var_220 & 16777215);
      ...
      {
         var_776 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_489,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_515 = param1 & 4278190080;
         var_220 = !!var_418 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_75);
      }
      ...
      {
         var_515 = param1 << 24;
         var_220 = !!var_418 ? uint(var_515 | var_220) : uint(16777215 & var_220);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_75);
      }
      
      public function set blend(param1:Number) : void
      {
         var_687 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_1075);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_543,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_350 = this._parent.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_416,this,this._parent));
            }
            else
            {
               this.var_350.x = 0;
               this.var_350.y = 0;
               this.var_350.width = 0;
               this.var_350.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_981,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_729,var_11);
            this.var_20.visible = var_356;
         }
         return this.var_20;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_19,var_15,var_11,null,this.var_631,this.properties,var_775.concat(),_id) as WindowController;
         _loc2_.var_419 = var_419;
         _loc2_.var_153 = this.var_153;
         _loc2_._debug = this._debug;
         _loc2_.var_350 = this.var_350.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_355 = var_355.clone();
         _loc2_.var_56 = var_56.clone();
         _loc2_.var_132 = !!var_132 ? var_132.clone() : null;
         _loc2_.var_133 = !!var_133 ? var_133.clone() : null;
         _loc2_.var_70 = !!var_70 ? var_70.clone(_loc2_) : null;
         _loc2_.var_15 = var_15;
         _loc2_.var_220 = var_220;
         _loc2_.var_515 = var_515;
         _loc2_.var_776 = var_776;
         _loc2_.var_356 = var_356;
         _loc2_.var_687 = var_687;
         _loc2_.var_19 = var_19;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_37;
         _loc2_.background = var_418;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2661 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_480)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_423)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_438)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1029,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_788,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_512,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_169,this,null));
            }
         }
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param4 != null && var_133 != null)
         {
            param4.x = var_133.x;
            param4.y = var_133.y;
            param4.width = var_133.width;
            param4.height = var_133.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_133.x = param3.x;
            var_133.y = param3.y;
            var_133.width = param3.width;
            var_133.height = param3.height;
         }
         if(param2 != null)
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_40:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_899;
                  if(testParamFlag(WindowParam.const_332))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_213))
                        {
                  ...
                  if((var_19 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_262))
                        {
                           var_15.getWindowServices().getMouseScalingService().begin(_loc3_,var_19 & 0);
                           break;
                        }
                        _loc3_ = _loc3_.parent;
                     }
               ...
               case WindowMouseEvent.const_60:
                  ...
                  if(testParamFlag(WindowParam.const_213))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_169:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_464,this,null));
                     if(testParamFlag(WindowParam.const_188,WindowParam.const_158))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_173,WindowParam.const_151))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_460))
                        {
               ...
               case WindowNotifyEvent.const_512:
                  var_15.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_481);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_900,this,null));
                     if(this._parent != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_331:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_684,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_198,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_543:
                  var_15.invalidate(this,var_11,WindowRedrawFlag.const_977);
                  break;
               case WindowNotifyEvent.const_517:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1548) == -1)
                     {
                        _loc8_.style = var_78;
                     }
                  }
               ...
               case WindowNotifyEvent.const_489:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        var_15.invalidate(this,var_11,WindowRedrawFlag.const_481);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_464:
                  this._parent.getRegionProperties(null,this.var_350);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_353:
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1036:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1363:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1450:
               _loc2_ = "null";
               break;
         ...
         if(this.var_153 && var_419 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1438,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1438,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_135,WindowParam.const_158);
         var _loc2_:* = !testParamFlag(WindowParam.const_133,WindowParam.const_151);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_350.width;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.WINDOW_PARAM_RELATIVE_HORIZONTAL_SCALE_STRECH)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_338)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_350.height;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_314)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_358)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_500)
         {
            return true;
         }
         _state = WindowState.const_500;
      ...
      public function maximize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_938;
         this.update(this,_loc1_);
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1118,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_331;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1031,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_1036;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_1087;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_754;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1176 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_353,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1176 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_632,this,param1));
         return param1;
      }
