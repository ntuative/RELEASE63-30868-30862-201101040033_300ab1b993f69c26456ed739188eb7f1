package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1334:uint = 0;
      
      public static const const_729:uint = 1;
      
      public static const const_960:uint = 2;
      
      public static const const_733:uint = 4;
      
      public static const const_1506:uint = 8;
      
      public static const const_1346:uint = 16;
      
      public static const const_1641:uint = 64;
      
      public static const const_1745:uint = 128;
      
      public static const const_941:uint = 256;
      ...
      protected var var_1926:Boolean;
      
      protected var var_770:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_960:
               ...
               break;
            case GraphicContext.const_1506:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1346:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_733:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_941:
               break;
            case GraphicContext.const_1334:
               break;
            default:
         ...
         if(this.var_770)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1926,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1926,16777215);
                  }
                  var_294 += bitmap.width * bitmap.height * 4;
               }
