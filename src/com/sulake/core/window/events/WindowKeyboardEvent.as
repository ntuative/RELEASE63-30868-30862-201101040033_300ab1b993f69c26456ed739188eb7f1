package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_363:String = "WKE_KEY_UP";
      ...
      private var var_707:KeyboardEvent;
      ...
      {
         _type = param1;
         this.var_707 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get charCode() : uint
      {
         return this.var_707.charCode;
      }
      
      public function get keyCode() : uint
      {
         return this.var_707.keyCode;
      }
      
      public function get keyLocation() : uint
      {
         return this.var_707.keyLocation;
      }
      
      public function get altKey() : Boolean
      {
         return this.var_707.altKey;
      }
      
      public function get shiftKey() : Boolean
      {
         return this.var_707.shiftKey;
      }
      
      override public function clone() : Event
      {
         return new WindowKeyboardEvent(_type,this.var_707,window,related,bubbles,cancelable);
      }
