package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1278:int = 10000;
      ...
      private var var_1060:IEncryption;
      
      private var var_700:IProtocol;
      
      private var _id:String;
      
      private var var_1059:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1059 = new MessageClassManager();
         this.var_72 = new Socket();
         this.var_326 = new Timer(const_1278,1);
         this.var_326.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1059.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         {
            _loc3_ = this.var_1060.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1059.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1060 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1059.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_469.writeByte(this.var_72.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_326.delay + " ms). Possible Firewall.";
