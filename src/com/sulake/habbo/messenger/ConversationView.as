package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_860:int = 100;
      
      private static const const_1219:int = 20;
       
      
      private var var_127:HabboMessenger;
      
      private var var_2390:IScrollbarWindow;
      
      private var var_1688:IContainerButtonWindow;
      
      private var var_54:IItemListWindow;
      
      private var var_475:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_127 = param1;
         this.var_1688 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_54 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2390 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_860 + const_1219)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_475 == null || _loc1_.id != this.var_475.id)
         {
            this.var_475 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_475.followingAllowed)
         {
            this.var_1688.enable();
         }
         else
         {
            this.var_1688.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_54.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_475.messages.length - const_860);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_475.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_475.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_751 || param3.type == Message.const_803 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_475.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_127.send(new FollowFriendMessageComposer(this.var_475.id));
      }
