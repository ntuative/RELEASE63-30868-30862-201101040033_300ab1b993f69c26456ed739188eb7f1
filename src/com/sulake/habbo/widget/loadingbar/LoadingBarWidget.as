package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_479:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_479.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_479 = null;
         }
         if(this.var_40 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_306,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_306,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         this.var_1187 = param1.clickUrl;
         var _loc2_:IDisplayObjectWrapper = this._window.findChildByName("image") as IDisplayObjectWrapper;
         if(_loc2_ == null)
         {
            return;
         }
         var _loc3_:int = Math.max(0,this.var_40.width - _loc2_.width);
         var _loc4_:int = Math.max(0,this.var_40.height - _loc2_.height);
         this._window.scale(_loc3_,_loc4_);
         if(this.var_479 == null)
         {
            this.var_479 = new Sprite();
            this.var_479.addChild(new Bitmap(this.var_40));
            this.var_479.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_479.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_40;
            }
         }
         _loc2_.setDisplayObject(this.var_479);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_306)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1187 != "")
         {
            HabboWebTools.openWebPage(this.var_1187);
         }
      }
   }
}
