package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_832:int = 16;
      
      private static const const_1152:int = 40;
      ...
      private var var_433:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_990 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2095 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2096 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_308 = new Timer(1000,1);
         this.var_308.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_362 = new Timer(10000,1);
         this.var_362.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_308.reset();
            this.var_308.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         }
         this.var_308 = null;
         if(this.var_362 != null)
         {
            this.var_362.reset();
            this.var_362.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         }
         this.var_362 = null;
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_109,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_364,this.onWindowMoved);
         this.var_1536 = true;
         this.var_439 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2094 = _loc2_.width + const_832 + _loc6_.width + const_1153;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1152,_loc8_.width) + const_832);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_433 = param1 - this.var_2094;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_433);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_433);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_990 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_439 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_439.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_439 = _loc2_.text;
            if(!this.var_549)
            {
               this.var_549 = true;
               this.var_308.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_549);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_433)
         {
      ...
      private function sendChatFromInputField(param1:int) : void
      {
         ...
         if(this._widget != null)
         {
            if(this.var_308.running)
            {
               this.var_308.reset();
            }
            if(this.var_362.running)
            {
               this.var_362.reset();
            }
