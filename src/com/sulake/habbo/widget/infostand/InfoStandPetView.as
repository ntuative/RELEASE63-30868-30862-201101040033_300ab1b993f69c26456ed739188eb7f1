package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_1378:Map;
      
      private var var_609:int;
      
      private const const_1854:int = 158;
      
      private const const_1849:int = 16;
      
      private const const_1853:uint = 11184810;
      
      private const const_1852:uint = 6710886;
      
      private const const_1851:uint = 3355443;
      
      private const const_1856:String = "level";
      
      private const const_1848:String = "experience";
      
      private const const_1850:String = "energy";
      
      private const const_1855:String = "nutrition";
      ...
      {
         if(this.var_48 == null || this.var_202 == null || this.var_62 == null)
         {
            return;
         }
         ...
         this.var_202.height = this.var_48.height + 20;
         this._window.width = Math.max(this.var_202.width,this.var_62.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_202.width < this.var_62.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1856,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1848,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1850,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1855,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_609 = param1.id;
         this.var_1378.remove(param1.id);
         this.var_1378.add(param1.id,param1);
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_183.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1854,this.const_1849,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1853);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1851);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1852);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1378.getValue(this.var_609) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_48 = this.var_202.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_183 && this.var_183.getPetId() == this.var_609)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_466,this._widget.petData.ownerId);
