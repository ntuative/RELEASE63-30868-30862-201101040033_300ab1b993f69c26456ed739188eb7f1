package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_450,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_418,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_529,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_507,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_450,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_418,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_529,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_507,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_66:
               ...
               this.showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_418:
               if(!this.var_329)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_529:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_507:
               if(!this.var_329)
               {
                  return;
               }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1155,const_1156,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_329 || this.var_328 == -1 || !this._controller)
         {
            return;
         }
         this.var_329 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_153,this.var_328);
