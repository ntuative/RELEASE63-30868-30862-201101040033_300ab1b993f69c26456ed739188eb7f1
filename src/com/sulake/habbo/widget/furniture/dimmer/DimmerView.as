package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1155:Number = 100;
      
      private static const const_1156:Number = 100;
      ...
      private var var_559:DimmerViewColorGrid;
      
      private var var_365:DimmerViewAlphaSlider;
      ...
      public function showInterface() : void
      {
         ...
         this.selectPreset(this._widget.method_4);
         this.update();
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1155,const_1156,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_559 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_365 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_227 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.method_4);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_227.numTabItems)
         {
            _loc6_ = this.var_227.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1271 = _loc2_.light;
         if(this.var_365 != null)
         {
            this.var_365.setValue(this.var_1271);
         }
         this.var_443 = this.colors.indexOf(_loc2_.color);
         if(this.var_559 != null)
         {
            this.var_559.setSelectedColorIndex(this.var_443);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_227.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_227.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_227.selector.getSelected();
         return this.var_227.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1272 = XML(_loc1_.content);
         return this.var_1272;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_365 != null)
         {
            this.var_365.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_559 != null)
         {
            this.var_559.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
