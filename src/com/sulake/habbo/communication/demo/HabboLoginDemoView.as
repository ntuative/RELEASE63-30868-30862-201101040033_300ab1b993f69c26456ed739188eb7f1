package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_414:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_152.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_130,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1570,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_152.habboConfiguration.getKey("use.sso","TradingYouAreNotAllowedParser") == "ObjectMouseData")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1570,"/");
         ...
         {
            dispatchEvent(new Event(const_414));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_128.removeEventListener(SSOTicket.const_359,this.onParsedTicketSuccess);
            this.var_128.removeEventListener(SSOTicket.const_259,this.onParsedTicketFailure);
            this.var_128 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_128.addEventListener(SSOTicket.const_359,this.onParsedTicketSuccess);
         this.var_128.addEventListener(SSOTicket.const_259,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_152.shockwaveClientUrl = this.var_128.shockwaveClientUrl;
