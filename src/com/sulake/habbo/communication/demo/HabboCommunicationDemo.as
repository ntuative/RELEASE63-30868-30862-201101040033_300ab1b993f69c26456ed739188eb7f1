package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_462:IKeyExchange;
      ...
      private var var_201:HabboHotelView;
      
      private var var_1304:String = "";
      
      private const const_1570:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_579 = param1;
            this.var_46.initConnection(HabboConnectionType.const_207);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_92,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_46 && this._habboConfiguration && this.var_17 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_201 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_201.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this._habboConfiguration.getKey("use.sso.ticket") == "1";
         this.var_579 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1635 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2305 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_201 == null)
         {
            this.var_201 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_46.mode = HabboConnectionType.const_102;
            if(this.var_579)
            {
               this.var_46.initConnection(HabboConnectionType.const_207);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_414,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_46.mode = HabboConnectionType.const_1105;
            }
         }
         this.var_46.initConnection(HabboConnectionType.const_207);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_787);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         {
            case HabboConnectionType.const_102:
               _loc6_ = "";
               ...
               this.var_1304 = _loc4_;
               this.var_201.loadBannerImage(_loc7_ + "?token=" + this.var_1304,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1105:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1374:
               this.var_850 = this.generateRandomHexString(30);
               this.var_462 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_462.init(this.var_850);
               _loc8_ = this.var_462.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_462.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_462.getSharedKey(16).toUpperCase();
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1303 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_227);
         connection.send(new VersionCheckMessageComposer(401,this.var_1635,this.var_2305));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1570,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_579 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_579);
            _loc2_.send(_loc4_);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_250);
      }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_245);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1303)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_161);
         }
         if(param1.type == Event.CLOSE && !this.var_2307)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1304);
         ...
         this.var_462 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_462.init(_loc14_);
            _loc15_ = this.var_462.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_850 = _loc14_;
            }
