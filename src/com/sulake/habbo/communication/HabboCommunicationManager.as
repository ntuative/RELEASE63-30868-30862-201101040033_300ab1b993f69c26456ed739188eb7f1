package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private var var_1350:IMessageConfiguration;
      ...
      {
         this.var_1350 = new HabboMessages();
         this.var_246 = [];
         this.var_1382 = new Timer(100,1);
      ...
      {
         if(this.var_246.length == 0 || this.var_401 < 0 || this.var_401 >= this.var_246.length)
         {
            return 0;
         }
         return this.var_246[this.var_401];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_285.registerProtocolType(HabboProtocolType.const_912,WedgieProtocol);
            this._connection = this.var_285.createConnection(HabboConnectionType.const_207,ConnectionType.const_1053);
            _loc3_ = this.var_285.getProtocolInstanceOfType(HabboProtocolType.const_912);
            this._connection.registerMessageClasses(this.var_1350);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!_loc4_)
            {
               Core.crash("Tried to connect to an invalid host: " + this.var_33,Core.const_294);
               return;
            }
            _loc5_ = _loc3_.split(",");
      ...
      public function initConnection(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_207:
      ...
      private function nextPort() : void
      {
         ...
         ++this.var_401;
         if(this.var_401 >= this.var_246.length)
         {
            ...
            if(this.var_903 > _loc1_)
            {
               ...
               this.var_2539 = true;
               Core.error("Connection failed to host " + this.var_33 + " ports " + this.var_246,true,Core.const_294);
               return;
            }
            this.var_401 = 0;
         }
         this._connection.timeout = this.var_903 * 10000;
         this._connection.init(this.var_33,this.var_246[this.var_401]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_246[this.var_401]);
         this.tryNextPort();
      }
      ...
      {
         this.var_1382.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1382.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_246[this.var_401]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_285 ? this.var_285.queueConnection(HabboConnectionType.const_207,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_285)
         {
            this.var_285.addConnectionMessageEvent(HabboConnectionType.const_207,param1);
         }
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1344,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1302,param1 + " " + param2);
      ...
      public function messageSent(param1:String, param2:String) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1426,param1 + " " + param2);
         if(this.var_123.length > 0)
         {
