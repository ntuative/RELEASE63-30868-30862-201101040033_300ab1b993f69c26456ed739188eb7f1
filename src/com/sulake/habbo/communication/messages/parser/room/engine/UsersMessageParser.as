package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      {
         if(param1 < 0 || param1 >= this.method_5())
         {
            return null;
         }
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc13_ == 1)
            {
               ...
               _loc14_.userType = RoomObjectTypeEnum.const_340;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_1061;
               ...
               _loc14_.sex = UserMessageData.const_1078;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1291;
         }
         return UserMessageData.const_1078;
      }
