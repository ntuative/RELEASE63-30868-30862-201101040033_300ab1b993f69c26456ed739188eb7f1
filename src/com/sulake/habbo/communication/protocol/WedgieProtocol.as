package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1348:uint = 1;
      
      public static const const_1306:uint = 2;
       
      
      private var var_1354:IProtocolEncoder;
      
      private var var_1089:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1354 = new WedgieEncoder();
         this.var_1089 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1348)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1089.getID(_loc4_);
