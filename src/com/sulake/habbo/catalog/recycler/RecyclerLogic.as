package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_179:int = 5;
      
      private static const const_887:int = 0;
      
      private static const const_395:int = 1;
      ...
      {
         return this.var_613 != const_887;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1837 != RecyclerStatusMessageEvent.const_922;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_613 == const_395;
      }
      ...
      {
         this.var_613 = const_888;
         this.var_110 = new Array(const_179);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_179)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_613 = const_887;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1404:
               this.var_613 = const_395;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_922:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1345:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1063:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1533:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_110.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_179)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_110.length < const_179)
         {
            return false;
         }
         var _loc1_:int = 0;
