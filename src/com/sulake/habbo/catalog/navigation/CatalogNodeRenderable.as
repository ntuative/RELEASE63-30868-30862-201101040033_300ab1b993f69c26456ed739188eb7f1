package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1258:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1431:XML;
      
      private static var var_1432:XML;
       
      
      private var var_1877:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2724:IWindowContainer;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1431 == null)
         {
            ...
            var_1431 = _loc4_.content as XML;
         }
         if(var_1432 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1877 == 4294967295)
            {
               this.var_1877 = _loc1_.color;
            }
            _loc1_.color = const_1258;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1503;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1259;
            }
         }
      }
      ...
      {
         this.var_54 = navigator.catalog.windowManager.buildFromXML(var_1432) as IItemListWindow;
         if(this.var_54 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1431) as IWindowContainer;
         }
         else
         {
