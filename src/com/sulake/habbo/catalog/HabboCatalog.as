package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_300:CatalogViewer;
      
      private var var_301:ICatalogNavigator;
      ...
      private var var_263:ChargeConfirmationDialog;
      ...
      private var var_1984:GiftWrappingConfiguration;
      
      private var var_968:ClubGiftController;
      
      private var var_426:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_189 == null)
            {
               this.var_189 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_189.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_426.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_301.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_101.getActivityPointsForType(Purse.const_523)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_755)
         {
            if(!this.var_368.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_300.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_301 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_300 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_300.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_213,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1480 = param1.session.isPrivateRoom;
               if(this.var_85 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_968 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_426 == null)
         {
            this.var_426 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_301.buildCatalogIndex(_loc2_);
         if(this.var_637 && this.var_637 != "")
         {
            this.var_301.openPage(this.var_637);
            this.var_637 = "";
            this.var_788 = -1;
         }
         else if(this.var_788 > -1)
         {
            this.var_301.openPageById(this.var_788,this.var_1479);
            this.var_788 = -1;
            this.var_1479 = -1;
            this.var_637 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_300.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_300 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_300.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_1982 && this.var_527 != null)
         {
            this.var_527.playSound(HabboSoundTypesEnum.const_932);
         }
         this.var_1982 = false;
         if(this.var_263 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_1983 && this.var_527 != null)
         {
            this.var_527.playSound(HabboSoundTypesEnum.const_1058);
         }
         this.var_1983 = false;
         if(this.var_263 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_968.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_300.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_1984 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_263 == null)
         {
            this.var_263 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_263.showChargeInfo(_loc2_);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "ObjectMouseData" == this._configuration.getKey("client.credits.embed.enabled"))
            {
