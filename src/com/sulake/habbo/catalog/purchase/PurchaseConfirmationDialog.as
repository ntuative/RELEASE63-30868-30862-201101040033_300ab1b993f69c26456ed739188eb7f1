package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1579:uint = 4.293848814E9;
      
      private const const_1578:uint = 4.294967295E9;
      
      private const const_1828:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1466 = _loc1_.stuffTypes;
            this.var_635 = _loc1_.boxTypes;
            this.var_636 = _loc1_.ribbonTypes;
            this.var_963 = this.var_1466[0];
            this.var_296 = this.var_635[0];
            this.var_297 = this.var_636[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_297 < 0)
         {
            this.var_297 = this.var_636.length - 1;
         }
         if(this.var_297 > this.var_636.length - 1)
         {
            this.var_297 = 0;
         }
         if(this.var_296 < 0)
         {
            this.var_296 = this.var_635.length - 1;
         }
         if(this.var_296 > this.var_635.length - 1)
         {
            this.var_296 = 0;
         }
         var _loc1_:int = this.var_635[this.var_296] * 1000 + this.var_636[this.var_297];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_89.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_963,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1208 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1466;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_963);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_635[this.var_296]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_636[this.var_297]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_89,this.var_1209,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_89.offerId,this.var_1209);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_109:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_1967 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_214)
               {
            ...
            case WindowMouseEvent.const_40:
               ...
               break;
            case WindowKeyboardEvent.const_363:
      ...
      {
         if(this.var_221 == null || !this.var_221.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_221.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_221 == null)
         {
            this.var_221 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_526 == null)
         {
            this.var_526 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_526.procedure = this.suggestionsEventHandler;
         }
         if(this.var_221 == null || this.var_526 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_221.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_526.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1828;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1579) : uint(this.const_1578);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_221.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_963;
               }
            }
            _loc4_++;
         }
