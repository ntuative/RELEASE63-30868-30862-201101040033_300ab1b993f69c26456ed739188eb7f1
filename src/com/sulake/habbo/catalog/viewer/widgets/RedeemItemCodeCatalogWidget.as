package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1065.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1064 != null)
         {
            this.var_1064.removeEventListener(WindowKeyboardEvent.const_145,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1065 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1065 != null)
         {
            this.var_1065.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1064 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1064 != null)
         {
            this.var_1064.addEventListener(WindowKeyboardEvent.const_145,this.windowKeyEventProcessor);
         }
      }
