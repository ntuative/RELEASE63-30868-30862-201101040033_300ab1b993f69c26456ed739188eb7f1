package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1828:XML;
      
      private var var_748:BitmapData;
      
      private var var_1027:BitmapData;
      ...
      override public function init() : void
      {
         ...
         this.var_1828 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1406.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_323 = null;
         for each(_loc1_ in this.var_1406)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1828) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(this.var_748.width,this.var_748.height,true,0);
               _loc3_.bitmap.copyPixels(this.var_748,this.var_748.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_1027.width,this.var_1027.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_829.width,this.var_829.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_829,this.var_829.rect,new Point(0,0),null,null,true);
