package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.initLinks();
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.method_13);
      }
      
      private function method_13(param1:SelectProductEvent) : void
      {
         if(param1 == null)
         {
            return;
               ...
               switch(_loc4_)
               {
                  ...
                  case "ctlg_txt7":
                     if(IWindow(param1.target).caption != "")
                     {
                        ...
                        {
                           if(false && "ObjectMouseData" == _loc3_.getKey("client.credits.embed.enabled"))
                           {
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         var _loc5_:String = this.var_898[param1];
