package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_1042 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_1042 != null)
         {
            this.var_1042.addEventListener(WindowKeyboardEvent.const_363,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_1042.text));
      }
   }
}
