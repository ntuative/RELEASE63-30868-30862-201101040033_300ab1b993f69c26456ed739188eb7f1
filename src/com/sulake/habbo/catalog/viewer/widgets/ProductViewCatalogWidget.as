package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1883:BitmapData;
      
      private var var_944:ITextWindow;
      
      private var var_1174:ITextWindow;
      
      private var var_83:IBitmapWrapperWindow;
      
      private var var_1884:Point;
      
      private var var_507:IItemGridWindow;
      
      private var var_1437:IScrollbarWindow;
      
      protected var var_1731:XML;
      
      private var var_2660:Array;
      ...
      {
         this.var_944 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1174 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1884 = new Point(this.var_83.x,this.var_83.y);
         this.var_507 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1437 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1883 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_944.text = _loc4_;
         this.var_1174.text = _loc5_;
         this.var_944.height = this.var_944.textHeight + 5;
         this.var_1174.y = this.var_944.y + this.var_944.height;
         this.var_1174.height = Math.max(130,this.var_1174.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_504:
                  _loc6_ = this.var_1883.clone();
                  if(this.var_507 != null)
                  {
                     this.var_507.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_507,this.var_1437,this.var_1731);
                     ...
                     case ProductTypeEnum.const_218:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_295,AvatarAction.const_473);
                              _loc16_.appendAction(AvatarAction.const_291,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2660)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2660 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1884.x;
            this.var_83.y = this.var_1884.y;
            if(param3 != null)
            {
