package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1881:IProductData;
      ...
      {
         super();
         this.var_1879 = param1.productType;
         this.var_1878 = param1.furniClassId;
         this.var_1435 = param1.extraParam;
         this.var_1434 = param1.productCount;
         this.var_1880 = param1.expiration;
