package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2563,this.var_372,this._toolbar);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_571 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         {
            _loc3_ = this.var_210[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_571 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_571 + const_556;
            _loc2_++;
         }
         return _loc1_;
      }
