package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1553:String = "no_reqs_info";
      ...
      {
         this.var_1544 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1545 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1545.procedure = this.onDismissAllButtonClick;
         this.var_1544.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_91,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_935)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_317 && _loc4_.state != FriendRequest.const_328)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1544,_loc1_);
         this.setEnabled(this.var_1545,_loc1_);
      }
