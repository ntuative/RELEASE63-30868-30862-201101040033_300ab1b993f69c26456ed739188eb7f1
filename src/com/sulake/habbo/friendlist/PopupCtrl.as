package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_50 == null)
         {
            this.var_50 = IWindowContainer(this._friendList.getXmlWindow(this.var_1319));
            this.var_50.visible = false;
            param1.addChild(this.var_50);
         }
         this.refreshContent(this.var_50);
         this.var_50.width = Util.getRightmostPoint(this.var_50) + 10;
         this.var_50.height = Util.getLowestPoint(this.var_50) + 10;
         var _loc3_:Point = new Point();
         var _loc4_:Point = new Point();
         param1.getGlobalPosition(_loc3_);
         param2.getGlobalPosition(_loc4_);
         this.var_50.x = _loc4_.x - _loc3_.x + this.var_2541 + param2.width;
         this.var_50.y = _loc4_.y - _loc3_.y - this.var_50.height * 0.5 + param2.height * 0.5;
         var _loc5_:Point = new Point();
         this.var_50.getGlobalPosition(_loc5_);
         if(_loc5_.x + this.var_50.width > this.var_50.desktop.width)
         {
            this.var_50.x = -this.var_50.width + _loc4_.x - _loc3_.x + this._popupIndentLeft;
