package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_142:String = "face";
      ...
      private var var_1034:IAvatarRenderManager;
      
      private var var_758:ISessionDataManager;
      
      private var var_2632:FriendListLookAndFeel;
      
      private var var_367:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1847:OpenedToWebPopup;
      
      private var var_2054:int;
      
      var var_92:FriendCategories;
      
      private var var_348:FriendRequests;
      
      private var var_1846:AvatarSearchResults;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1846 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_616.stop();
            this.var_616.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_616 = null;
         }
         ...
         if(this.var_1034)
         {
            this.var_1034.release(new IIDAvatarRenderManager());
            this.var_1034 = null;
         }
         if(this.var_799)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1847 = new OpenedToWebPopup(this);
         }
         this.var_1847.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_93);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_348.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_297,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1034.createAvatarImage(param1,AvatarScaleType.const_83,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1034 = param2 as IAvatarRenderManager;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_348 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_1014,this.getText("friendlist.friends")));
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_343,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_92.addFriend(new Friend(_loc4_));
         }
         this.var_367 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_616)
         {
            this.var_616 = new Timer(120000);
            this.var_616.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_616.start();
         }
         ...
         {
            _loc5_ = this.var_92.findCategory(FriendCategory.const_343);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_367.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_378));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_348.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_348.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_367.findTab(FriendListTab.const_91).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_348.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_367.findTab(FriendListTab.const_91);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1846.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_367.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         {
            _loc2_ = this.var_348.vipLimit;
         }
         else if(this.var_758.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_348.clubLimit;
         }
         if(_loc2_ > this.var_348.limit)
         {
            this.var_348.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_142) as IBitmapWrapperWindow;
