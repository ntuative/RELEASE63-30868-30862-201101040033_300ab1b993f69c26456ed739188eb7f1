package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_810:String = "bg";
      ...
      private var var_2489:IContainerButtonWindow;
      
      private var var_2490:IContainerButtonWindow;
      
      private var var_2488:IContainerButtonWindow;
      
      private var var_54:IItemListWindow;
      
      private var var_377:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_377 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_2489 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2490 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2488 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_810);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_93,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_810);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_93,param1);
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2489,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2490,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2488,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_377.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_377.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_377.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_298)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_298 && _loc4_.online)
            {
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_93,param4);
         _loc6_.visible = true;
      }
