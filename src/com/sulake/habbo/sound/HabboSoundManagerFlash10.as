package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_923,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_800.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1018:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1482:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1518:
               ...
               case HabboSoundTypesEnum.const_1058:
                  ...
                  break;
               case HabboSoundTypesEnum.const_932:
            ...
            this.var_800.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_430;
         _loc2_.play();
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_644.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_644,events);
         _loc8_.volume = this.var_430;
         this.var_798 = null;
         this.var_645 = -1;
         if(_loc5_.length != 0)
         {
      ...
      {
         if(this._configuration == null || this._connection == null || this._roomEngine == null || this.var_539 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         this.var_644.add(_loc3_,_loc6_);
         if(this.var_540.length == 0 && this.var_645 != -1)
         {
            this.var_798.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_923,this.var_645));
            this.var_645 = -1;
            this.var_798 = null;
         }
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1350,this.var_645));
         this.var_645 = -1;
         this.var_798 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_430 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_430 * 100)));
         }
      }
      ...
      {
         this.var_430 = param1;
         this.var_539.updateVolume(this.var_430);
