package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private var var_94:Vector.<Number> = null;
      
      private var _events:IEventDispatcher;
      
      private var var_430:Number;
      
      private var var_1312:Sound;
      
      private var _soundChannel:SoundChannel;
      
      private var var_1648:TraxData;
      
      private var var_1647:Map;
      ...
      {
         this.var_1649 = uint(const_258 / 44.1);
         super();
         this._events = param4;
         this.var_2333 = param1;
         this.var_430 = 1;
         this.var_1312 = new Sound();
         ...
         this._length = 0;
         this.var_1313 = false;
         this.var_94 = new Vector.<Number>(const_258,true);
      }
      ...
      public function play() : Boolean
      {
         ...
         this.var_1313 = false;
         this.var_1312.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1312.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1312.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      public function set volume(param1:Number) : void
      {
         ...
         if(this._soundChannel != null)
         {
            this._soundChannel.soundTransform = new SoundTransform(this.var_430);
         }
      }
      ...
      {
         return Math.ceil(param1 / const_1210);
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1648.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1648.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1647.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         var _loc4_:* = [];
         var _loc5_:* = null;
         var _loc6_:int = this.var_699.length;
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc2_.push(this.var_699[_loc7_].getKeys());
            _loc12_ = 0;
            ...
            _loc13_ = this.var_699[_loc7_].getWithIndex(_loc12_);
         ...
         while(_loc7_ >= 0)
         {
            ...
            while(_loc18_ < _loc17_)
            {
               ...
               if(_loc7_ == _loc6_ - 1)
               {
                  if(_loc5_ != null)
                  {
                     _loc5_.setSample(this.var_94,_loc18_,_loc19_);
                     _loc18_ += _loc19_;
                  }
                  else
                  {
               ...
               else
               {
                  if(_loc5_ != null)
                  {
                     _loc5_.addSample(this.var_94,_loc18_,_loc19_);
                  }
                  _loc18_ += _loc19_;
               }
               if(_loc18_ < _loc17_)
               {
                  if(_loc16_ < this.var_699[_loc7_].length - 1)
                  {
                     _loc21_ = this.var_699[_loc7_].getWithIndex(++_loc16_);
                     if(_loc21_.id == 0)
                     {
                        _loc5_ = null;
                     }
         ...
         {
            _loc8_ = Number(this.var_94[_loc10_] * this.volume);
         ...
         this.var_204 += const_258;
         if(this._soundChannel != null)
         {
            this.var_1649 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_204 > this._length + this.var_1649 * 44.1)
         {
            this.var_1313 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_698,this.var_2333));
      }
   }
}
