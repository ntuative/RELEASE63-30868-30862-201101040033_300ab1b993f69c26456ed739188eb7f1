package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1839:String = "type_sound_machine";
      
      private const const_1574:String = "type_jukebox";
      
      private var var_527:HabboSoundManagerFlash10;
      
      private var _connection:IConnection;
      
      private var _events:IEventDispatcher;
      
      private var var_88:IEventDispatcher;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_698,this.onSongFinishedPlayingEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_789,this.onSoundMachinePlayEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_655,this.onSoundMachineStopEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_785,this.onJukeboxInitEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_406,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_698,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_88)
            {
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_789,this.onSoundMachinePlayEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_655,this.onSoundMachineStopEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_785,this.onJukeboxInitEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_406,this.onDisposeEvent);
               this.var_88 = null;
            }
            if(this.var_378)
            {
      ...
      {
         this.startPlaying(this.const_1839);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(this.var_71 == null || this.var_71.length == 0)
         {
         ...
         if(_loc2_ != null)
         {
            this.var_277 = _loc2_.id;
            this.playSong(this.var_277);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_378[this.var_277] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_378.getValue(this.var_277) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_277 = param1;
         var _loc2_:IHabboSound = this.var_378.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_527.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_527.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_277)
         {
            _loc6_ = this.var_378[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1639 == this.const_1574)
         {
            this.var_71.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function getNextEntry() : PlayListEntry
      {
         ...
         {
            _loc2_ = this.var_71[_loc3_];
            if(_loc2_.id == this.var_277)
            {
               _loc1_ = _loc3_ + 1;
            }
            _loc3_++;
         }
         if(_loc1_ >= this.var_71.length)
         {
            _loc1_ = 0;
         }
         return this.var_71[_loc1_];
      }
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_581.indexOf(param1) == -1)
         {
            this.var_581.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_71.length)
            {
               _loc6_ = this.var_71[_loc5_] as PlayListEntry;
               if(_loc6_.id == _loc3_.id)
               {
                  this.var_71.splice(_loc5_,1);
                  _loc4_ = false;
                  break;
               }
               _loc5_++;
         ...
         this.var_581 = this.var_581.splice(this.var_581.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_378[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_527.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_378.add(_loc3_.id,_loc7_);
            }
      ...
      private function onPlayListSongAddedMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_71.push(_loc4_);
         if(this.var_71.length == 1)
         {
