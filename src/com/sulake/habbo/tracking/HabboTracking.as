package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_831:uint = 11;
      ...
      private var var_980:IHabboWindowManager;
      ...
      private var var_224:PerformanceTracker = null;
      
      private var var_547:FramerateTracker = null;
      
      private var var_225:LatencyTracker = null;
      
      private var var_546:LagWarningLogger = null;
      
      private var var_545:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_224 = new PerformanceTracker();
         this.var_547 = new FramerateTracker();
         this.var_225 = new LatencyTracker();
         this.var_546 = new LagWarningLogger();
         this.var_545 = new ToolbarClickTracker(this);
         this.var_1240 = new Array(const_831);
         var _loc4_:int = 0;
         while(_loc4_ < const_831)
         {
            this.var_1240[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1481,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1483,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1375,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_740,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1079,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_980)
            {
               this.var_980.release(new IIDHabboWindowManager());
               this.var_980 = null;
            }
            if(this.var_286)
            {
            ...
            if(this.var_176)
            {
               if(!this.var_176.disposed)
               {
                  Component(this.var_176).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_176).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_176).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_176).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_378,this.onFriendlistTrackingEvent);
               }
               this.var_176.release(new IIDHabboFriendList());
               this.var_176 = null;
            }
            if(this.var_158)
            {
               if(!this.var_158.disposed)
               {
                  this.var_158.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_158.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_158.release(new IIDHabboHelp());
               this.var_158 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_225 != null)
            {
               this.var_225.configuration = this._configuration;
            }
            if(this.var_224 != null)
            {
               this.var_224.configuration = this._configuration;
            }
            ...
            if(this._configuration)
            {
               ...
               {
                  this.var_546.configure(this._configuration);
               }
               if(this.var_547 != null)
               {
                  this.var_547.configure(this._configuration);
               }
               if(this.var_545 != null)
               {
                  this.var_545.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_787,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_227,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_182,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_161,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_250,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_245,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_805,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_63,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_535,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_224 != null)
            {
               this.var_224.connection = param1;
            }
            if(this.var_225 != null)
            {
               this.var_225.communication = this._communication;
               this.var_225.connection = param1;
            }
            if(this.var_546 != null)
            {
               this.var_546.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_805)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1517);
         }
         else if(param1.type == HabboHotelViewEvent.const_535)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1395);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_787:
               this.trackLoginStep(HabboLoginTrackingStep.const_1373,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_227:
               this.trackLoginStep(HabboLoginTrackingStep.const_227);
               break;
            case HabboCommunicationEvent.const_161:
               this.trackLoginStep(HabboLoginTrackingStep.const_161);
               break;
            case HabboCommunicationEvent.const_182:
               this.setErrorContextFlag(2,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_182);
               break;
            case HabboCommunicationEvent.const_250:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_250);
               if(this.var_225 != null)
               {
                  this.var_225.init();
               }
            ...
            case HabboCommunicationEvent.const_245:
               this.trackLoginStep(HabboLoginTrackingStep.const_245);
         }
         if(this._communication)
         {
      ...
      {
         this.var_980 = IHabboWindowManager(param2);
         if(this.var_980)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1240)
                  {
                  ...
                  if(this.var_224 != null)
                  {
                     _loc4_["null"] = this.var_224.flashVersion;
                     _loc4_["null"] = this.var_224.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_936);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_936,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_176 = param2 as IHabboFriendList;
         Component(this.var_176).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_176).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_176).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_176).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_176).events.addEventListener(HabboFriendListTrackingEvent.const_378,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_378:
      ...
      {
         this.var_158 = param2 as IHabboHelp;
         this.var_158.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_158.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2073)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1467);
            this.var_2073 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1079,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_287,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_286 = param2 as IAdManager;
         this.var_286.events.addEventListener(AdEvent.const_434,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_545)
         {
            this.var_545.track(param1.iconName);
         }
      }
      ...
      {
         this.var_546.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_437 > -1 && _loc2_ < this.var_437)
         {
            ++this.var_1522;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1522);
         }
         if(this.var_437 > -1 && _loc2_ - this.var_437 > 15000)
         {
            ++this.var_1523;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1523);
         }
         this.var_437 = _loc2_;
         if(this.var_224 != null)
         {
            this.var_224.update(param1,this.var_437);
         }
         if(this.var_225 != null)
         {
            this.var_225.update(param1,this.var_437);
         }
         if(this.var_547 != null)
         {
            this.var_547.trackUpdate(param1,this,this.var_437);
         }
         if(this.var_546 != null)
         {
            this.var_546.update(this.var_437);
         }
      }
   }
}
