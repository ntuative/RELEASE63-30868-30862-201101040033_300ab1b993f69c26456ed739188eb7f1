package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_805:Array = [];
      
      private static var var_1517:int = 1000;
      
      private static var var_806:Array = [];
      
      private static var var_1518:int = 200;
      ...
      private var var_1515:IMessageComposer;
      ...
      {
         this.var_649 = IWindowContainer(this.var_32.getXmlWindow("chatlog_roomheader"));
         this.var_650 = IWindowContainer(this.var_32.getXmlWindow("chatlog_chatline"));
         ...
         this.var_32.connection.send(this.var_1515);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_805.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_650.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_805.length < var_1517)
         {
            ...
            param1.width = this.var_650.width;
            param1.height = this.var_650.height;
            var_805.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_806.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_649.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_806.length < var_1518)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_649.width;
            param1.height = this.var_649.height;
            var_806.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1516[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1236.getValue(param2.chatterName))
            {
               this.var_1236.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1236.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1237)
         {
