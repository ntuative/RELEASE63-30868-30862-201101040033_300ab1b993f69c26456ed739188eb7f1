package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this._frame = IFrameWindow(this.var_32.getXmlWindow("send_msgs"));
         this._frame.caption = "Msg To: " + this.var_1787;
      ...
      {
         return WindowTracker.const_1320;
      }
      ...
      {
         Logger.log("MSG TEMPLATES: " + this.var_32.initMsg.messageTemplates.length);
         param1.populate(this.var_32.initMsg.messageTemplates);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_32.initMsg.messageTemplates[this.var_1117.selection];
         if(_loc3_ != null)
         {
            this.var_560 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.connection.send(new ModMessageMessageComposer(this.var_1426,this.var_506.text,this.var_1427));
         this.dispose();
      }
