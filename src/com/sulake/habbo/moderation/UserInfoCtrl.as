package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_839:int = 60;
      
      private static const const_838:int = 3600;
      
      private static const const_840:int = 86400;
      
      private static const const_841:int = 31536000;
      ...
      {
         if(param1 < 2 * const_839)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_838)
         {
            return Math.round(param1 / const_839) + " mins ago";
         }
         if(param1 < 2 * const_840)
         {
            return Math.round(param1 / const_838) + " hours ago";
         }
         if(param1 < 2 * const_841)
         {
            return Math.round(param1 / const_840) + " days ago";
         }
         return Math.round(param1 / const_841) + " years ago";
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         this._data = null;
         this.refresh();
         this.var_32.messageHandler.addUserInfoListener(this);
         this.var_32.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_32.messageHandler.removeUserInfoListener(this);
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1022.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_32.getXmlWindow("user_info"));
            this.var_1022.addChild(_loc1_);
            this.var_32.disableButton(this.var_32.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_32.disableButton(this.var_32.initMsg.alertPermission,_loc1_,"message_but");
            this.var_32.disableButton(this.var_32.initMsg.alertPermission || this.var_32.initMsg.kickPermission || this.var_32.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_32,WindowTracker.const_1052,this._data.userId),this._callerFrame,this.var_1021,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new RoomVisitsCtrl(this.var_32,this._data.userId),this._callerFrame,this.var_1021,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.openHkPage("habboinfotool.url",this._data.userName);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new SendMsgsCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1427),this._callerFrame,this.var_1021,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ModActionCtrl(this.var_32,this._data.userId,this._data.userName,this.var_1427),this._callerFrame,this.var_1021,false,true);
      }
      ...
      {
         this.var_32.openHkPage("moderatoractionlog.url",this._data.userName);
      }
   }
}
