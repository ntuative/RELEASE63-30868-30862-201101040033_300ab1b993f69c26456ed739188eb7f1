package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_506:ITextFieldWindow;
      
      private var var_560:Boolean = true;
      
      private var var_917:ICheckBoxWindow;
      
      private var var_1394:ICheckBoxWindow;
      
      private var var_1395:ICheckBoxWindow;
      ...
      {
         this._frame = IFrameWindow(this.var_32.getXmlWindow("roomtool_frame"));
         this.var_32.messageHandler.addRoomInfoListener(this);
         this.var_32.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_339));
         Logger.log("BEGINNING TO SHOW: " + this.var_339);
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_32.messageHandler.removeRoomEnterListener(this);
         if(this._frame != null)
         {
            this._frame.destroy();
            this._frame = null;
      ...
      {
         var _loc2_:Boolean = this._data != null && this._data.flatId == this.var_32.currentFlatId;
         var _loc3_:IButtonWindow = IButtonWindow(this._frame.findChildByName(param1));
         if(_loc2_ && this.var_32.initMsg.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_339);
         if(param1.flatId != this.var_339)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_339);
            return;
         }
         this._data = param1;
         this.populate();
         this.var_32.messageHandler.removeRoomInfoListener(this);
         this._frame.visible = true;
         this.var_32.messageHandler.addRoomEnterListener(this);
      ...
      public function populate() : void
      {
         ...
         this.var_506 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_506.procedure = this.onInputClick;
         ...
         this.var_917 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1394 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1395 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
         ...
         if(!this.var_32.initMsg.roomKickPermission)
         {
            this.var_917.disable();
         }
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = IWindowContainer(this.var_32.getXmlWindow("roomtool_roomdata"));
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new UserInfoFrameCtrl(this.var_32,this._data.ownerId),this._frame,false,false,true);
      }
      ...
      private function onEnterRoom(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.goToRoom(this._data.flatId);
      }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_32,WindowTracker.const_725,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_32.openHkPage("roomadmin.url","" + this._data.flatId);
      }
      ...
      {
         if(this.var_560 || this.var_506.text == "")
         {
            this.var_32.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_917.isSelected);
         this.var_32.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1270,_loc2_,this.var_506.text,"",""));
         if(this.var_1394.isSelected || this.var_1395.isSelected || this.var_917.isSelected)
         {
            this.var_32.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1394.isSelected,this.var_1395.isSelected,this.var_917.isSelected));
         }
         this.dispose();
      }
      ...
      {
         Logger.log("MSG TEMPLATES: " + this.var_32.initMsg.roomMessageTemplates.length);
         param1.populate(this.var_32.initMsg.roomMessageTemplates);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_32.initMsg.roomMessageTemplates[this.var_1117.selection];
         if(_loc3_ != null)
         {
            this.var_560 = false;
            this.var_506.text = _loc3_;
         }
      }
   }
}
