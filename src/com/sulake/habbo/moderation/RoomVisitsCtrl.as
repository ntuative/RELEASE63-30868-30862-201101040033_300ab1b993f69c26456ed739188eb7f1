package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_809:Array = [];
      
      private static var var_1526:int = 200;
      ...
      {
         this.var_652 = IWindowContainer(this.var_32.getXmlWindow("roomvisits_row"));
         this.var_438 = new Timer(300,1);
         this.var_438.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_32.messageHandler.addRoomVisitsListener(this);
         this.var_32.connection.send(new GetRoomVisitsMessageComposer(this._userId));
         this._frame = IFrameWindow(this.var_32.getXmlWindow("roomvisits_frame"));
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         this.var_32.messageHandler.removeRoomVisitsListener(this);
      }
      ...
      private function populate() : void
      {
         var _loc2_:* = null;
         var _loc1_:* = true;
         for each(_loc2_ in this.var_102)
         {
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         new OpenRoomTool(this._frame,this.var_32,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(this.var_32,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_809.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_652.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_809.length < var_1526)
         {
            ...
            param1.width = this.var_652.width;
            param1.height = this.var_652.height;
            var_809.push(param1);
         }
         else
         {
