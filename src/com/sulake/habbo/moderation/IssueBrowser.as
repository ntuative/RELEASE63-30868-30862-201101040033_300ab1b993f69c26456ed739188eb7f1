package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1835:String = "my_issues";
      
      private const const_1836:String = "open_issues";
      
      private const const_1834:String = "picked_issues";
      
      private const const_1873:String = "closed_issues";
      ...
      private var var_306:IIssueBrowserView;
      
      private var var_1534:IIssueBrowserView;
      
      private var var_1533:IIssueBrowserView;
      
      private var var_1535:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_227 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_227.numTabItems)
            {
               _loc5_ = this.var_227.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_227 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_227 == null || this.var_227.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_227.selector.getSelectableByName("open_issues");
         this.var_227.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_306 == _loc2_)
         {
            return;
         }
         ...
         this.var_306.view.width = this.var_227.container.width;
         this.var_306.view.height = this.var_227.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1835:
               if(this.var_1534 == null)
               {
                  this.var_1534 = new MyIssuesView(this.issueManager,this,this.var_227.container);
               }
               return this.var_1534;
            case this.const_1836:
               if(this.var_1533 == null)
               {
                  this.var_1533 = new OpenIssuesView(this.issueManager,this,this.var_227.container);
               }
               return this.var_1533;
            case this.const_1834:
               if(this.var_1535 == null)
               {
                  this.var_1535 = new PickedIssuesView(this.issueManager,this,this.var_227.container);
               }
