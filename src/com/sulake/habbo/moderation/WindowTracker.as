package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1320:int = 2;
      
      public static const const_917:int = 3;
      
      public static const const_725:int = 4;
      
      public static const const_1052:int = 5;
      
      public static const const_1277:int = 6;
      
      public static const const_1441:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1378:int = 9;
       
      
      private var var_1827:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1827 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1827[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1827[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
