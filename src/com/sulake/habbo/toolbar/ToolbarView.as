package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_500:String = "LEFT";
      
      private var var_149:Number = 50;
      
      private var var_1143:Boolean = true;
      
      private var var_1142:Number = 1;
      
      private var var_1397:Number = 0;
      
      private var var_1811:Number = 15;
      ...
      {
         this.var_2719 = new Array();
         this.var_251 = new Array();
         this.var_608 = new Array();
         super();
         this._events = param3;
         ...
         this.var_149 = this._window.width;
         this.var_211 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_959,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1143 = String(_loc6_.relocate_by_drag.@state) == "ObjectMouseData";
         if(this.var_1143)
         {
         ...
         this.var_1142 = _loc6_.toolbar.@margin_top;
         this.var_1397 = _loc6_.toolbar.@margin_bottom;
         this.var_1811 = _loc6_.toolbar.@min_group_margin;
         this.var_1810 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_284 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_251,param1,param2,this._window,this.var_284);
         this.createGroupsFromXmlList(_loc8_,this.var_608,param1,param2,this.var_211,this.var_284);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_149);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_251.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(this.var_608.length > 0)
         {
            _loc1_ = this.var_608.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_149,this.var_500,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_500);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_149,this.var_500);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_149,this.var_500);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_608.length)
         {
            _loc2_ = this.var_608[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_211 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_211.x = this.var_149 + this.var_1810;
               this.var_211.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_149;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_149;
               this._window.y = 0;
               this.var_211.x = 0;
               this.var_211.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_149;
               this._window.x = 0;
               this._window.y = 0;
               this.var_211.x = 0;
               this.var_211.y = this.var_149 + this.var_1810;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_149;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_149;
               this.var_211.x = 0;
               this.var_211.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1397;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1142;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_251.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1811,(this._window.height - _loc5_ * _loc8_ - this.var_1142 - this.var_1397) / (this.var_251.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1811,(this._window.width - _loc5_ * _loc8_ - this.var_1142 - this.var_1397) / (this.var_251.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_251.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_500;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_608.length)
         {
            _loc3_ = this.var_608[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_149)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_149)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_149)
         {
            return "BOTTOM";
         }
         return null;
