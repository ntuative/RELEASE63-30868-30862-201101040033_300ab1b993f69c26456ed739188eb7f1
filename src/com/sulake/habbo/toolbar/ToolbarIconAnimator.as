package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1385 = param1.loop;
         if(param1.background != null)
         {
            this.var_905 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_906.push(new XML());
               this.var_907.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_907[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1385 == true || this.var_904 == 0)
         {
            if(this.var_906.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_906.length)
               {
                  this._frame = 0;
                  ++this.var_904;
               }
      ...
      {
         return this.var_906.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1385 == false && this.var_904 == 1 && this.var_1483 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_907.length)
         {
            _loc2_ = this.var_907[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_905.width),Math.max(param2.height,this.var_905.height));
            _loc3_.copyPixels(this.var_905,this.var_905.rect,new Point(0,0));
