package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1150:Number = 25;
      
      private static const const_1249:Number = 90;
      
      private static const const_830:int = 50;
      
      private static const const_1149:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1230:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_537 = new Object();
         this.var_535 = new Array();
         this.var_536 = new Array();
         super();
         this._windowManager = param1;
         this.var_1230 = param2;
         this.var_642 = new Timer(const_1150);
         this.var_642.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function animateWindowIn(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         ...
         _loc8_.offsetLoc = this.method_7(param2,param3,param5);
         if(const_189)
         {
      ...
      public function positionWindow(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:Array = null) : void
      {
         ...
         _loc7_.offsetLoc = this.method_7(param2,param3,param5);
         if(const_189)
         {
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_304[_loc1_],true);
            _loc1_++;
         }
      }
      
      private function method_7(param1:String, param2:IWindowContainer, param3:Number) : Point
      {
      ...
      {
         return param1.x + param1.width < const_830 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_830 || param1.desktop.height - param1.y < const_1149;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1230.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_304.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1230.getIconLoc(param1.iconId);
      ...
      {
         return this.var_535[this.var_536.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_536[this.var_535.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_536.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_536.splice(_loc3_,1);
            this.var_535.splice(_loc3_,1);
         }
         this.var_535.push(param1.name);
         this.var_536.push(param2);
         param1.addEventListener(WindowEvent.const_364,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_235,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_537[_loc3_] == null)
            {
               this.var_537[_loc3_] = new Array();
            }
            if(this.var_537[_loc3_].indexOf(param1) < 0)
            {
               this.var_537[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_304.indexOf(param1) > -1)
         {
            if(const_189)
            {
            ...
            else
            {
               ...
               this.var_304.splice(this.var_304.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_535.length)
         {
            if(this.var_535[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_536[_loc2_];
               if(this.var_537[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_537[_loc3_].length)
                  {
                     this.repositionWindow(this.var_537[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_304.length)
         {
            _loc2_ = this._itemList[this.var_304[_loc7_]];
            if(_loc2_.active)
            {
