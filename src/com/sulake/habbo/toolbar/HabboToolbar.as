package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1398:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","TradingYouAreNotAllowedParser") == "ObjectMouseData")
         {
            this.var_1398 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1091,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_155,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_479,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1019,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_975,this.onHideWindowEvent);
         this._state = true;
