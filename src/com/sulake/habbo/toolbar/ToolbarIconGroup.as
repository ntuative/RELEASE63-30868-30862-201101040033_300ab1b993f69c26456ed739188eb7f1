package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_604:ToolbarBarMenuAnimator;
      ...
      private var var_2116:int = 5;
      
      private var var_2118:int;
      
      private var var_149:Number;
      
      private var var_2117:XML;
            ...
            if(_loc2_ != null)
            {
               if(!this.containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     {
                        _loc3_ = "null";
                        this.var_1250.push(_loc3_);
                        _loc6_.dockMenu(_loc3_,this.getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "ObjectMouseData");
                        _loc9_++;
                     }
                  }
                  else
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2117.elements("menu");
         var _loc5_:int = 0;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1251.length)
         {
            _loc2_ = this.var_658.indexOf(this.var_1251[_loc4_]);
            if(_loc2_ > -1)
            {
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_268[this.var_658.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_604);
