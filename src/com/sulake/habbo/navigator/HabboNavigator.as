package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_289:MainViewCtrl;
      
      private var var_618:RoomInfoViewCtrl;
      
      private var var_1163:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_367:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2754:Dictionary;
      
      private var _incomingMessages:IncomingMessages;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_2645:Array;
      
      private var var_1966:RoomThumbnailRenderer;
      
      private var var_909:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_289 = new MainViewCtrl(this);
         this.var_618 = new RoomInfoViewCtrl(this);
         this.var_1163 = new RoomCreateViewCtrl(this);
         this.var_1966 = new RoomThumbnailRenderer(this);
         this.var_909 = new GuestRoomPasswordInput(this);
         this.var_338 = new GuestRoomDoorbell(this);
         this.var_367 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_297,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_618.registerToolbarEvents();
      }
      ...
      {
         var _loc1_:Boolean = this.var_289.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_289.startSearch(Tabs.const_243,Tabs.const_350,param1);
         this.var_289.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_289.startSearch(Tabs.const_278,Tabs.const_237);
         this.var_367.getTab(Tabs.const_278).tabPageDecorator.tabSelected();
      }
