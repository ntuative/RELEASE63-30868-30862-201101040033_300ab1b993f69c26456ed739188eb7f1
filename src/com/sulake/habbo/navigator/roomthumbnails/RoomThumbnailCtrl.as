package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_61:ThumbnailEditorModel;
      
      private var var_1776:IButtonWindow;
      
      private var var_1778:IButtonWindow;
      
      private var var_1777:IButtonWindow;
      ...
      public function RoomThumbnailCtrl(param1:HabboNavigator)
      {
         ...
         this.var_61 = new ThumbnailEditorModel();
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(this._active)
         {
            this.var_61.data = this._navigator.data.enteredGuestRoom.thumbnail.getCopy();
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1776 = IButtonWindow(this.find("bg_tab"));
         this.var_1778 = IButtonWindow(this.find("top_tab"));
         this.var_1777 = IButtonWindow(this.find("obj_tab"));
         this.var_2519 = IWindowContainer(this.find("tile_grid"));
         this.var_2520 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1776,this.onBgTabButton);
         Util.setProcDirectly(this.var_1778,this.onTopTabButton);
         Util.setProcDirectly(this.var_1777,this.onObjTabButton);
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this.var_61.data.objects)
         {
            if(_loc4_.imgId > 0)
            {
               _loc3_.push(_loc4_);
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(this._navigator.data.enteredGuestRoom.flatId,this.var_61.data.bgImgId,this.var_61.data.frontImgId,_loc3_.length);
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_61.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_61.mode = ThumbnailEditorModel.const_54;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_61.mode = ThumbnailEditorModel.const_34;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1776,this.var_61.mode != ThumbnailEditorModel.const_36);
         this.setEnabled(this.var_1778,this.var_61.mode != ThumbnailEditorModel.const_54);
         this.setEnabled(this.var_1777,this.var_61.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2520;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_61.mode == ThumbnailEditorModel.const_36);
         this.refreshEditImg(_loc1_,"edit_top",this.var_61.mode == ThumbnailEditorModel.const_54);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_61.mode == ThumbnailEditorModel.const_34,false);
         if(this.var_61.mode == ThumbnailEditorModel.const_34)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2519;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_409)
            {
         ...
         if(this.var_61.selected == null)
         {
            _loc2_.visible = false;
            return;
         }
         _loc2_.visible = true;
         this.refreshTileLoc(_loc2_,this.var_61.selected.pos);
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Dictionary = this.var_61.getBlockedPositions();
         while(_loc3_ <= RoomThumbnailRenderer.const_409)
         {
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = this.var_61.getImgId();
         var _loc6_:int = 0;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_31,HabboWindowParam.const_58,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_297,HabboWindowStyle.const_37,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
      ...
      {
         this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this._window.findChildByName("picframe")),this.var_61.data,false);
      }
   }
}
