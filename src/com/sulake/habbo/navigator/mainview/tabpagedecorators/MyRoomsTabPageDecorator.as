package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_474 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_474.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_474 == null ? 0 : int(this.var_474.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         this._navigator.mainViewCtrl.startSearch(Tabs.const_278,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_614;
         }
         if(param1 == 2)
         {
            return Tabs.const_722;
         }
         if(param1 == 3)
         {
         ...
         if(param1 == 4)
         {
            return Tabs.const_762;
         }
         return Tabs.const_237;
      }
   }
}
