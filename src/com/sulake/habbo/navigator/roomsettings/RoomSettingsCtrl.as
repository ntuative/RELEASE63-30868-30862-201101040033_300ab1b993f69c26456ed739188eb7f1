package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1125:TextFieldManager;
      
      private var var_1121:ICheckBoxWindow;
      
      private var var_1120:ICheckBoxWindow;
      
      private var var_1124:ICheckBoxWindow;
      
      private var var_606:ICheckBoxWindow;
      ...
      private var var_1793:IWindowContainer;
      ...
      private var var_2544:ITextWindow;
      
      private var var_2543:ITextWindow;
      ...
      {
         this.var_339 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_339));
         if(this.var_1127 != null)
         {
            this.var_1127.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_339)
         {
            return;
         }
         this.var_74 = param1;
      ...
      {
         if(param1 != this.var_339 || this.var_1122 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_741.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1510)
         {
            this.var_741.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1427)
         {
            this.var_1126.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1505)
         {
            this.setTagError(this.var_894,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_896,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1485)
         {
            this.setTagError(this.var_894,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_896,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         ...
         {
            this.var_741.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_741,this.onDoorModePasswordUnselect);
         ...
         this.var_741 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1126 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_894 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_896 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_909 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1125 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1121 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1120 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1124 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_606 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1791 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1386 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1128 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1123 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1793 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1387 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_247 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1127 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2544 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2543 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1790 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1790.procedure = this.onSwitchView;
         this.var_1127.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1791.visible = this._inRoom;
         this.var_1793.visible = this._inRoom;
         this.var_2543.visible = this.var_493;
         this.var_2544.visible = !this.var_493;
         if(this.var_493)
         {
            this.var_1123.visible = true;
            this.var_1387.visible = false;
            this.refreshFlatControllers();
            this.var_1123.height = Util.getLowestPoint(this.var_1123) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1128.visible = true;
            this.var_1387.visible = true;
            this.var_1386.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1386.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1128.height = Util.getLowestPoint(this.var_1128) + 4;
         }
         this.var_1790.text = !!this.var_493 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1791.name,this.var_1386.name,this.var_1128.name,this.var_1123.name,this.var_1387.name,this.var_1793.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_741.setText(_loc1_.name);
         this.var_1126.setText(_loc1_.description);
         this.var_909.setText("");
         this.var_1125.setText("");
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_111);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_894,_loc1_.tags[0]);
         this.setTag(this.var_896,_loc1_.tags[1]);
         if(this.var_1121)
         {
            if(_loc1_.allowPets)
            {
               this.var_1121.select();
            }
            else
            {
               this.var_1121.unselect();
            }
         }
         if(this.var_1120)
         {
            ...
            {
               this.var_1120.select();
            }
            else
            {
               this.var_1120.unselect();
            }
         }
         if(this.var_1124)
         {
            ...
            {
               this.var_1124.select();
            }
            else
            {
               this.var_1124.unselect();
            }
         }
         if(this.var_606)
         {
            ...
            {
               this.var_606.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_606.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_741.getText();
         _loc2_.description = this.var_1126.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_541;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_111)
         {
            _loc8_ = this.var_909.getText();
            _loc9_ = this.var_1125.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_909.clearErrors();
               this.var_1125.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1121.isSelected;
         _loc2_.allowFoodConsume = this.var_1120.isSelected;
         _loc2_.allowWalkThrough = this.var_1124.isSelected;
         _loc2_.hideWalls = this.var_606.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_894,_loc2_.tags);
         this.addTag(this.var_896,_loc2_.tags);
         this.clearErrors();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_339);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_74.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_339]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_31,HabboWindowParam.const_58,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_339));
      }
