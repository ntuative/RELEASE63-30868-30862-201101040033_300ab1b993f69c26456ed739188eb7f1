package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1075:TextFieldManager;
      
      private var var_39:Array;
      
      private var var_1074:RoomLayout;
      
      private var var_589:Timer;
      
      private var var_1690:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_589 = new Timer(100);
         this.var_589.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_39 = new Array();
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,104,"a"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,94,"b"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,36,"c"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,84,"d"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"e"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"f"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,416,"i"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,320,"j"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,448,"k"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,352,"l"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,384,"m"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_49,372,"n"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,80,"g"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,74,"h"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,416,"o"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,352,"p"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,304,"q"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,336,"r"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,748,"u"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_56,438,"v"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_52,540,"t"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_52,512,"w"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_52,396,"x"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_52,440,"y"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_52,456,"z"));
         this.var_39.push(new RoomLayout(HabboClubLevelEnum.const_52,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_589)
         {
            this.var_589.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_589.reset();
            this.var_589 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1074.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1690 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1690 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_162 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_54 = IItemListWindow(this.var_162.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_162.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1075 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_162.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_162.desktop,this.var_162.width,this.var_162.height);
         this.var_162.x = _loc4_.x;
         this.var_162.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1075.goBackToInitialState();
         this.var_1075.input.textBackgroundColor = 4294967295;
         this.var_1074 = this.var_39[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < this.var_39.length)
         {
            _loc7_ = this.var_39[_loc4_];
            if(this.isAllowed(_loc7_))
            {
               ...
               this.addThumbnail(_loc3_,this.var_39[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_31,HabboWindowParam.const_58,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1075.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_162.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_162.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1075.getText();
         var _loc3_:String = "model_" + this.var_1074.name;
         if(!this.isMandatoryFieldsFilled())
         {
            return;
         }
         this._navigator.send(new CreateFlatMessageComposer(_loc2_,_loc3_));
         this.var_162.visible = false;
      }
