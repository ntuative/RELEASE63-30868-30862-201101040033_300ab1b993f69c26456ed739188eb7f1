package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_390:uint = 3;
      ...
      private var var_893:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_337:Array;
      
      private var var_1371:IEventDispatcher;
      
      private var var_1110:Boolean = false;
      
      private var var_1767:ProfilerOutput;
      
      private var var_1372:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_893 = new WindowRenderer(this._skinContainer);
         this.var_182 = new Array(const_390);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_390)
         {
            this.var_182[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_893,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_237 = this.var_182[const_1236];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_237.getMouseCursor().defineCustomCursorType(MouseCursorType.const_342,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_237.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1386,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1767)
            {
               this.var_1767 = new ProfilerOutput(context,this,this.var_893);
            }
            this.var_1767.profiler = _loc3_;
            this.var_1372 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1372);
            this.var_1373 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1373);
            this.var_1110 = true;
         }
      }
      ...
      {
         return this.var_237.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_237.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_337[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_337[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_182[param1].getDesktopWindow().getChildAt(this.var_237.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1371.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_390 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1371.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_390)
         {
         ...
         this.var_1371.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1267,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1351,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1284,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1394,param2.name + ": " + param2.toString());
            }
         }
      }
   }
