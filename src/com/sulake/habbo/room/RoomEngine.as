package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_554:String = "temporary_room";
      
      private static const const_311:int = -1;
      
      private static const const_555:String = "room";
      
      private static const const_879:int = -2;
      
      private static const const_1241:String = "tile_cursor";
      
      private static const const_877:int = -3;
      
      private static const const_1242:String = "selection_arrow";
      
      private static const const_878:String = "overlay";
      
      private static const const_310:String = "object_icon_sprite";
      ...
      private var var_914:IRoomRendererFactory = null;
      ...
      private var var_743:NumberBank;
      ...
      {
         super(param1,param2);
         this.var_343 = new Map();
         this.var_743 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_435.release(new IIDRoomObjectVisualizationFactory());
            this.var_435 = null;
         }
         if(this.var_42 != null)
         {
         ...
         {
            this.var_914.release(new IIDRoomRendererFactory());
            this.var_914 = null;
         }
         ...
         if(this.var_343 != null)
         {
            ...
            {
               _loc2_ = this.var_343.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_343.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_343.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = this.var_42.getRoom(this.getRoomIdentifier(this.var_97,this.var_98));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_343.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_97 || _loc6_ != this.var_98 || !this.var_1134)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_591) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_664) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_631) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_606) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_435 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_435;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_42 != null)
         {
            ...
            this.var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_292);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_914 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_800,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_800)
         {
            this.var_2556 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_286.events.addEventListener(AdEvent.const_434,this.showRoomAd);
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_23 != null)
         {
            ...
            {
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_200,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_457,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_413,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_117,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_759,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_132,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_131,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_122,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_100,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_415,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_470,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_525,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_538,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_455,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_396,this.roomObjectEventHandler);
               ...
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_437,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_497,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_421,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_518,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_59,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_491,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_420,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_287,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_449,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_372,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_346,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_427,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_1115,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_422,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_23 == null || this.var_435 == null || this.var_42 == null || this.var_914 == null || this._communication == null || this._habboConfiguration == null || !this.var_2556)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_495 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_737,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_342.length)
            {
               _loc3_ = this.var_342.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1084,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_502,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_506,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1084);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_495)
         {
            _loc5_ = this.var_342.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_342.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_708,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_911,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_816,1,true);
            _loc13_ = parseInt(this._habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1086,_loc13_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_311,const_555,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_816,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_689,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_591,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_631,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_664,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_606,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1037,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_628,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_763,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_744,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_501,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_244);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_636,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_688,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_636,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_990,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1003,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_879,const_1241,RoomObjectCategoryEnum.const_292);
         _loc7_.createRoomObject(const_877,const_1242,RoomObjectCategoryEnum.const_292);
         return _loc7_;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_342.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_342.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_628,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_763,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_744,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1385,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_901,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1059,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_343.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_757,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_914.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1077;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_689);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_688);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_636);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_990);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1003);
      ...
      {
         var _loc8_:int = param2 - this.var_1392;
         var _loc9_:int = param3 - this.var_1390;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1134 = true;
               this.var_913 = false;
               this.var_2557 = this.var_1392;
               this.var_2555 = this.var_1390;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1134)
            {
               if(!this.var_913)
               {
                  _loc8_ = param2 - this.var_2557;
                  _loc9_ = param3 - this.var_2555;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_310);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_539,this.var_97,this.var_98,-1,RoomObjectCategoryEnum.const_149));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_69 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_311,const_555);
                     this.var_69.handleRoomObjectEvent(_loc14_,this.var_97,this.var_98);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = this.getRoomObjectImage(this.var_97,this.var_98,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1391);
         if(_loc7_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc7_);
            this.removeOverlayIconSprite(_loc10_,const_310);
            _loc11_ = this.addOverlayIconSprite(_loc10_,const_310,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1392 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1390 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1391);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_310);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1391);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_310);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_69 != null)
         {
            return this.var_69.modifyRoomObject(this.var_97,this.var_98,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_69 != null)
         {
            ...
            {
               return this.var_69.modifyWallItemData(this.var_97,this.var_98,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_69 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_69.deleteWallItem(this.var_97,this.var_98,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_816) != 0)
         {
            return false;
         }
         if(this.var_69 != null)
         {
            return this.var_69.initializeRoomObjectInsert(this.var_97,this.var_98,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_69 != null)
         {
            this.var_69.cancelRoomObjectInsert(this.var_97,this.var_98);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_877,RoomObjectCategoryEnum.const_292);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_879,RoomObjectCategoryEnum.const_292);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_365,param4,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1039,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1027,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_280,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function method_6(param1:int, param2:int, param3:int) : void
      {
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_365,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_324,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1077,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_280,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1056) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1002);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_501,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_701,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_280,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_377);
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_652,this.var_97,this.var_98,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_69 != null)
         {
            this.var_69.handleRoomObjectEvent(param1,this.var_97,this.var_98);
         }
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_495 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_42.getRoom(const_554);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_42.createRoom(const_554,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_743.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_220,int(param2));
            ...
            case RoomObjectCategoryEnum.const_74:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_148,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_148,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_264,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_589,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_642,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_732,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_501,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            this.var_1135.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_992,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_743.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_97,this.var_98,const_311,RoomObjectCategoryEnum.const_74,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_42.getRoom(const_554);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_992);
               ...
               this.var_743.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1135.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_381,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_895,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1040,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1097,RoomObjectVariableEnum.const_381,param1.clickUrl);
