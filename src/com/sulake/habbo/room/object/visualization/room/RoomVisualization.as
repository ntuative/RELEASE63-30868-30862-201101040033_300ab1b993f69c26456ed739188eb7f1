package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1262:int = 16777215;
      
      public static const const_1274:int = 13421772;
      
      private static const const_875:int = 16777215;
      
      private static const const_872:int = 13421772;
      
      private static const const_874:int = 10066329;
      
      private static const const_873:int = 10066329;
      
      public static const const_1473:int = 16777215;
      
      public static const const_1419:int = 13421772;
      
      public static const const_1325:int = 10066329;
      ...
      private var var_728:Rectangle = null;
      
      private var var_483:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2447:String = null;
      
      private var var_1096:uint = 16777215;
      
      private var var_2448:int = 255;
      
      private var var_2446:int = 255;
      
      private var var_2449:int = 255;
      ...
      private const const_1844:int = 250;
      
      private var var_1708:int = -1;
      
      private var var_1348:Number = 0.0;
      
      private var var_2419:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_483 = new RoomPlaneBitmapMaskParser();
         this.var_282["null"] = false;
         this.var_282["null"] = true;
         this.var_282["null"] = true;
         this.var_282["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_728 = super.boundingRectangle;
         }
         return new Rectangle(this.var_728.x,this.var_728.y,this.var_728.width,this.var_728.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1037);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_148)
            {
               ...
               {
                  _loc13_.color = const_873;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_875;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_872;
               }
               else
               {
                  _loc13_.color = const_874;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1486)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_106,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_264)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1844 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_330.length)
            {
               _loc10_ = this.var_600[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_330[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_90)
               {
                  if(this.var_1745)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2449 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2446 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2448 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1708)
         {
            this.var_1708 = param1.updateId;
            this.var_728 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1348 || _loc3_.y != this.var_2419 || _loc3_.z != this.var_2417 || param1.scale != this.var_2420))
            {
               this.var_1348 = _loc3_.x;
               this.var_2419 = _loc3_.y;
               this.var_2417 = _loc3_.z;
               this.var_2420 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1060);
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_791));
            if(_loc4_ != this.var_1096)
            {
               this.var_1096 = _loc4_;
               this.var_2449 = this.var_1096 & 255;
               this.var_2446 = this.var_1096 >> 8 & 255;
               this.var_2448 = this.var_1096 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1054));
            if(_loc5_ != this.var_1745)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_218 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_642);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_589);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_732);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_610));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_702));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_687));
      ...
      {
         if(param1 != this.var_282["null"] || param2 != this.var_282["null"] || param3 != this.var_282["null"])
         {
            this.var_282["null"] = param1;
            this.var_282["null"] = param2;
            this.var_282["null"] = param3;
            this.var_330 = [];
            this.var_600 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_330;
         if(this.var_330.length == 0)
         {
            _loc6_ = this.var_125;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_330.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_282[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_330.push(_loc12_);
                        this.var_600.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1689;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_483.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_483.maskCount)
         {
            _loc10_ = this.var_483.getMaskType(_loc8_);
            _loc11_ = this.var_483.getMaskLocation(_loc8_);
            _loc12_ = this.var_483.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_125.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_106 || _loc3_.type == RoomPlane.const_90)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_106 || _loc3_.type == RoomPlane.const_90 && _loc12_ == RoomPlaneBitmapMaskData.const_244)
                              {
