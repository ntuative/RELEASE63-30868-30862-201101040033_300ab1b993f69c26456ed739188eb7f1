package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1216:IGraphicAssetCollection;
      
      private var var_1789:XMLList;
      ...
      private var var_969:Point = null;
      
      private var var_1215:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_789)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1215 = this.var_39.getValue(this.var_789);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_39 != null)
         {
            ...
            {
               _loc2_ = this.var_39.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_39.add(_loc2_,_loc3_);
         this.var_1987 = new Vector3d(-0.5,0.5,0);
         this.var_790 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_1987);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_969.x = _loc3_.x;
         this.var_969.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         this.var_970 = param1;
         var _loc3_:LayoutRasterizerData = this.var_39.getValue(this.var_789);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1481 = RoomObjectVariableEnum.const_895;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1481 = RoomObjectVariableEnum.const_1040;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_970 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_970 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_39.getValue(this.var_789);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_1988 && param3 == this.var_1986)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_970 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_970 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1481);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_496;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1215.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1216.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_969.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_969.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_358.indexOf(_loc10_) >= 0 && this.var_790)
            {
               param1 = this.var_358.indexOf(_loc10_);
               if(this.var_528[param1] != "")
               {
                  _loc9_ = this.var_1216.getAsset(this.var_528[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_529[param1] != -1)
               {
                  param2.alpha = this.var_529[param1];
               }
               this.var_358.splice(param1,1);
               this.var_528.splice(param1,1);
               this.var_529.splice(param1,1);
      ...
      {
         this.var_790 = true;
         var _loc3_:int = this.var_358.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_358.push(param1);
            this.var_528.push(param2);
            this.var_529.push(-1);
         }
         else
         {
            this.var_528[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_358.push(param1);
            this.var_528.push("");
            this.var_529.push(param2);
         }
         else
         {
            this.var_529[_loc3_] = param2;
         }
      }
   }
}
