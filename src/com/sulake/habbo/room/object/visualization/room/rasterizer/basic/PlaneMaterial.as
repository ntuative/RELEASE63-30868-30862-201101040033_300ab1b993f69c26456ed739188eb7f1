   ...
   public class PlaneMaterial
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_321 != null)
         {
            ...
            {
               _loc2_ = this.var_321[_loc1_] as PlaneMaterialCellMatrix;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function method_15(param1:int, param2:int, param3:int, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0) : PlaneMaterialCellMatrix
      {
         var _loc8_:* = null;
         _loc8_ = new PlaneMaterialCellMatrix(param1,param2,param3,param4,param5,param6,param7);
         this.var_321.push(_loc8_);
         return _loc8_;
      }
      ...
      private function getMaterialCellMatrix(param1:IVector3d) : PlaneMaterialCellMatrix
      {
         ...
         {
            _loc3_ = this.var_321[_loc2_] as PlaneMaterialCellMatrix;
            if(_loc3_ != null)
            {
