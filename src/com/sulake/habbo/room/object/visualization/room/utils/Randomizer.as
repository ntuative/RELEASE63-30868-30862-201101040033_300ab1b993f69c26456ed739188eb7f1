package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1817:int = 1;
      
      public static const const_1653:int = 16777216;
      ...
      private var var_1714:int = 16777216;
      
      private var var_2708:int = 69069;
      
      private var var_2707:int = 5;
      ...
      {
         var _loc1_:int = this.var_2708 * this.var_1713 + this.var_2707;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1714;
         this.var_1713 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1714 * param2);
      }
   }
}
