package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      {
         super();
         this.var_404 = param1.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
      }
      ...
      public function setExperience(param1:int) : void
      {
         ...
         this.var_40 = (this.var_404.content as BitmapData).clone();
         ...
         this.var_40.draw(_loc3_,_loc4_);
      }
   }
}
