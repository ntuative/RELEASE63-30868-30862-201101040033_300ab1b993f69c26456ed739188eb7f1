package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_322:int = 1000;
      ...
      private var var_1355:int = 360;
      
      private var var_722:DirectionData = null;
      
      private var var_244:Map;
      
      private var _colors:Map;
      
      private var var_1091:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_722 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_722,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_722);
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_896);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1072);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1355 / 2) % 360 / this.var_1355;
         ...
         {
            _loc6_ = int(this.var_244.getKey(_loc5_)) * this.var_1355;
