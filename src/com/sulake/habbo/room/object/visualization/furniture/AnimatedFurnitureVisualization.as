package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_568);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_568);
                     if(_loc4_ > this.var_1601)
                     {
                        this.var_1601 = _loc4_;
      ...
      private function resetAnimationFrames() : void
      {
         ...
         this.var_1036 = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1582)
         {
            this.var_450[_loc1_] = null;
            this.var_574[_loc1_] = false;
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            if(this.var_451.hasAnimation(this.var_1602,AnimationData.getTransitionAnimationId(param1)))
            {
               if(this.var_1035 != AnimationData.getTransitionAnimationId(param1))
               {
      ...
      {
         if(param1 < 0 || param1 >= this.var_574.length)
         {
            return false;
         }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_1582 = this.var_451.getLayerCount(param1);
            this.resetAnimationFrames();
         }
         var _loc2_:Array = this.updateAnimationFrames(param1);
         if(this.var_1036 && _loc2_ != null && AnimationData.isTransitionAnimation(this.var_1035))
         {
            this.setAnimation(AnimationData.getAnimationId(this.var_1035));
      ...
      private function updateAnimationFrames(param1:Number) : Array
      {
         ...
         if(this.var_534 == 0)
         {
            this.var_534 = this.var_451.getStartFrame(param1,this.animationId,_direction);
         }
         this.var_534 += 1;
         var _loc3_:* = null;
         this.var_1036 = true;
         var _loc4_:int = this.var_1582 - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this._animationPlayed[_loc4_];
            if(!_loc5_)
            {
               _loc6_ = this.var_574[_loc4_];
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats >= 0 && _loc9_ <= 0)
               {
                  ...
                  if(_loc8_ == AnimationFrame.const_1008)
                  {
                     _loc7_ = this.var_451.getFrame(param1,this.animationId,_direction,_loc4_,this.var_534);
                  }
                  else
                  {
                     _loc7_ = this.var_451.getFrameFromSequence(param1,this.animationId,_direction,_loc4_,_loc8_,_loc7_.activeSequenceOffset + _loc7_.repeats,this.var_534);
                  }
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats == AnimationFrame.const_485)
               {
                  _loc6_ = true;
                  _loc5_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_450[param2] as AnimationFrame;
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_450[param3] as AnimationFrame;
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
