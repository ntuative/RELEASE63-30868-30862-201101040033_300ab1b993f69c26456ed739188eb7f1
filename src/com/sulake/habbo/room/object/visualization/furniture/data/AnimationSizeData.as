   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_318 != null)
         {
            ...
            {
               _loc2_ = this.var_318.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            this.var_318.add(_loc7_,_loc8_);
            _loc5_++;
         }
         return true;
      }
      ...
      {
         if(this.var_318.getValue(param1) != null)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc3_:AnimationData = this.var_318.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:AnimationData = this.var_318.getValue(param1) as AnimationData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc8_:* = null;
         var _loc7_:AnimationData = this.var_318.getValue(param1) as AnimationData;
         if(_loc7_ != null)
         {
