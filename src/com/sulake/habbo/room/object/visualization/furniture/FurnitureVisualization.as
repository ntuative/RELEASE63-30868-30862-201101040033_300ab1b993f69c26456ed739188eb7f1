package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1538:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2671:Number = NaN;
      
      protected var var_2672:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1187:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1582 != spriteCount)
         {
            createSprites(this.var_1582);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param2 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,param2,this.var_2672);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_896:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1072:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_414 != _loc3_.getUpdateID() || param1 != var_217 || param2 != this.var_2671)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2672 = _loc3_.getNumber(RoomObjectVariableEnum.const_220);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_274));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1187 = _loc3_.getString(RoomObjectVariableEnum.const_324);
            if(this.var_1187 == null || this.var_1187.indexOf("http") != 0)
            {
               this.var_1187 = null;
            }
      ...
      {
         if(this.var_2193 != param2 || this.var_2194 != param1)
         {
            this.var_826 = [];
            this.var_827 = [];
            this.var_672 = [];
            ...
            this.var_1582 = this._data.getLayerCount(param1) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_1038.length)
         {
            return "";
         }
         var _loc3_:String = this.var_826[param2];
         var _loc4_:Boolean = this.var_827[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param2 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_1038[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_826[param2] = _loc3_;
            this.var_827[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_668[param3] != null && !this.var_1583)
         {
            return this.var_668[param3];
         }
         if(this._data == null)
         {
         ...
         this.var_668[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteColor(param1:int, param2:int, param3:int) : int
      {
         if(this.var_670[param2] != null)
         {
            return this.var_670[param2];
         }
         if(this._data == null)
         {
