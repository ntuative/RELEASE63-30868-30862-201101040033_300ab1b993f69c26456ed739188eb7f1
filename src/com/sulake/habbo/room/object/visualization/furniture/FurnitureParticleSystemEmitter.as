package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1305:String = "cone";
      
      public static const const_1340:String = "plane";
      
      public static const const_1392:String = "sphere";
      ...
      private var var_787:Number = 0.1;
      
      private var var_1471:Number;
      
      private var var_222:Number;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_1471 = param5;
         this.var_222 = param6;
         this.var_1974 = param7;
         this.var_1973 = param9;
         this._energy = param8;
      ...
      public function reset() : void
      {
         ...
         this.var_786 = 0;
         this.var_808 = false;
         this.init(0,0,0,this._direction,this.var_1975,this.var_787,this.var_1973,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_967.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_808 = true;
         if(this.var_786 < this.var_1210)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_1971)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_787,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_299.push(_loc4_);
            ++this.var_786;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_967.length);
         return this.var_967[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_786 < this.var_1210)
         {
            if(this.age % this.var_1976 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_786 < this.var_1210)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_222) * this.x - (1 - this.var_222) * this.lastX;
            this.y = (2 - this.var_222) * this.y - (1 - this.var_222) * this.lastY + this.var_1471 * this.var_787 * this.var_787;
            this.z = (2 - this.var_222) * this.z - (1 - this.var_222) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_299)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_222) * _loc2_.x - (1 - this.var_222) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_222) * _loc2_.y - (1 - this.var_222) * _loc2_.lastY + this.var_1471 * this.var_787 * this.var_787;
            _loc2_.z = (2 - this.var_222) * _loc2_.z - (1 - this.var_222) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_299.splice(this.var_299.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
