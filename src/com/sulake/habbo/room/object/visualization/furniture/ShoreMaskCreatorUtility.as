package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_61:int = 2;
      ...
      {
         return param1 + param2 * const_1203;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_134,const_72,const_61,const_134,const_72,const_61];
                     _loc8_ = [const_72,const_72,const_72,const_61,const_61,const_61];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
