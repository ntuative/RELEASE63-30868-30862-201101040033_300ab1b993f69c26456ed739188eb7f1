package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_790,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_474,Number(false));
         this.var_755 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1321 > 0 && param1 > this.var_1321)
         {
            this.adDelayTimeout();
            this.var_1321 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1097:
                  _loc2_.setString(RoomObjectVariableEnum.const_381,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_790,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_474,Number(true));
                  this.var_1321 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1086);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_474,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_496)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_790);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_287,_loc5_,_loc6_,_loc7_));
