package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1563:int = 255;
      
      private var var_1278:uint = 16777215;
      
      private var var_1578:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1085,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_791,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_610,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_702,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_687,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1016)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1563;
            if(_loc2_ - this.var_1016 >= this.var_1576)
            {
               _loc3_ = this.var_1017;
               _loc4_ = this.var_1577;
               this.var_1016 = 0;
            }
            else
            {
               _loc7_ = this.var_1278 >> 16 & 255;
               _loc8_ = this.var_1278 >> 8 & 255;
               _loc9_ = this.var_1278 & 255;
               _loc10_ = this.var_1017 >> 16 & 255;
               _loc11_ = this.var_1017 >> 8 & 255;
               _loc12_ = this.var_1017 & 255;
               _loc13_ = (_loc2_ - this.var_1016) / this.var_1576;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1578 + (this.var_1577 - this.var_1578) * _loc13_;
               this._color = _loc3_;
               this.var_1563 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_791,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_628:
               param2.setString(RoomObjectVariableEnum.const_589,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_763:
               param2.setString(RoomObjectVariableEnum.const_642,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_744:
               param2.setString(RoomObjectVariableEnum.const_732,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_501:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_244)
               {
                  _loc5_ = "null";
               }
               this.var_483.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_701:
               _loc4_ = this.var_483.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_483.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1060,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1059:
               param2.setNumber(RoomObjectVariableEnum.const_610,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_901:
               param2.setNumber(RoomObjectVariableEnum.const_702,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_687,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1054,int(param1.bgOnly));
         this.var_1278 = this._color;
         this.var_1578 = this.var_1563;
         this.var_1017 = _loc3_;
         this.var_1577 = _loc4_;
         this.var_1016 = getTimer();
         this.var_1576 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_483,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1321,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1525,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1501,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_483,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_148 || _loc13_ == RoomPlaneData.const_264)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
