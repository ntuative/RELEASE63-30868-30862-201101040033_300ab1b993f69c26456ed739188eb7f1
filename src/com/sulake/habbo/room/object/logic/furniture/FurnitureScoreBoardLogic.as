package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_387:int = 50;
      
      private static const const_892:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         {
            _loc3_ = this.var_759 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_387 > const_892)
            {
               this.var_1111 = const_892 / _loc3_;
            }
            else
            {
               this.var_1111 = const_387;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_759 && param1 >= this.var_1420 + this.var_1111)
            {
               ...
               if(_loc4_ > _loc5_ * (this.var_759 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_759 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1420 = param1 - (_loc3_ - _loc4_ * this.var_1111);
            }
         }
      }
   }
