package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_682:FaqCategory;
      
      private var var_681:FaqCategory;
      
      private var var_680:FaqCategory;
      ...
      {
         super();
         this.var_682 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_681 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_680 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_682.hasItem(param1))
         {
            this.var_682.getItem(param1).answerText = param2;
         }
         if(this.var_681.hasItem(param1))
         {
            this.var_681.getItem(param1).answerText = param2;
         }
         if(this.var_680.hasItem(param1))
         {
            this.var_680.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_682.hasItem(param1))
         {
            return this.var_682.getItem(param1);
         }
         if(this.var_681.hasItem(param1))
         {
            return this.var_681.getItem(param1);
         }
         if(this.var_680.hasItem(param1))
         {
            return this.var_680.getItem(param1);
         }
         var _loc2_:int = 0;
