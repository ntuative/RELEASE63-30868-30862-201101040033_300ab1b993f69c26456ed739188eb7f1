package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1557:int = 0;
      
      private static const const_1556:int = 0;
      ...
      {
         this.var_312 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201101032336));
         this._toolbar = param5;
         this.var_93 = new Map();
         this.var_93.add(HabboHelpViewEnum.const_1361,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_181,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_472,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_288,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_203,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_670,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_323,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_801,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_210,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_93.add(HabboHelpViewEnum.const_986,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_93.add(HabboHelpViewEnum.const_1055,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_93.add(HabboHelpViewEnum.const_793,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_93.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_93.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_442.length == 0 || param1 != this.var_312)
            {
               this.var_442.push(this.var_312);
            }
         }
         this.var_312 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_312);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_210:
               this.showUI(HabboHelpViewEnum.const_210);
               break;
            case CallForHelpResultEnum.const_927:
               this.showUI(HabboHelpViewEnum.const_1055);
               break;
            case CallForHelpResultEnum.const_1108:
               this.showUI(HabboHelpViewEnum.const_986);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_93.getValue(HabboHelpViewEnum.const_181) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_401));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_93.length)
         {
            _loc3_ = this.var_93.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_93.getValue(this.var_312);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1551 = this._window.width - _loc4_.width;
         this.var_1552 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1552;
         this._window.width = _loc1_.width + this.var_1551;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_442.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_312 == HabboHelpViewEnum.const_181)
         {
            return;
         }
         if(this.var_551.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_551.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_551.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_311.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_551[1],this.var_551[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_551[0],this.var_551[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_312 == HabboHelpViewEnum.const_181 || this.var_442.length == 0)
         {
            return;
         }
         if(this.var_311 == null)
         {
            ...
            this.var_311 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_311.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_311.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_311 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_311 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_311 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
