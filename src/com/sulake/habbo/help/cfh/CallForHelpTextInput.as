package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1165:int = 30;
      
      private static const const_1164:int = 253;
      
      private static const const_1163:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_181);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1165)
         {
