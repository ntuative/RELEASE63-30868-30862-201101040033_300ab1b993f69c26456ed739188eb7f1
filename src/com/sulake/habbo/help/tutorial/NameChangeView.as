package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1267:uint = 13232628;
      
      private static var var_1559:uint = 11129827;
      ...
      private var var_1004:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1557 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_663)
         {
            this.var_663 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_663)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_663.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_446;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_446);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1004 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1004.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1267;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_446 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_446 != _loc5_)
               {
                  this.var_1558 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_446);
               break;
