package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_1860:int = 5;
      
      private const const_1859:int = 5;
      
      private var var_32:INameChangeUI;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            this._offsetX = 0;
            this.var_1137 += param1.height + this.const_1859;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1137);
         this._offsetX += param1.width + this.const_1860;
         return true;
      }
      
      private function createItem(param1:String) : ITextWindow
      {
         var _loc2_:ITextWindow = this.var_32.buildXmlWindow("tutorial_name_suggestion_item") as ITextWindow;
         if(_loc2_ == null)
         {
            return null;
         }
