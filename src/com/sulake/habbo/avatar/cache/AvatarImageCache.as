package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1590:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1306:IAvatarImage;
      ...
      private var var_79:AvatarCanvas;
      ...
      private var var_382:AvatarImageBodyPartContainer;
      
      private var var_1388:String;
      
      private var var_108:AvatarImagePartContainer;
      
      private var var_2550:Point;
      ...
      private var var_2549:ImageData;
      
      private var var_1803:PaletteMap;
      
      private var var_910:Array;
      
      private var var_912:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_742 == GeometryType.const_1023 && param1 == GeometryType.const_1120 || this.var_742 == GeometryType.const_1120 && param1 == GeometryType.const_1023)
         {
            this.var_742 = param1;
            this.var_79 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_341.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_703)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_407)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1306.getFigure(),_loc5_,this.var_742,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_382 = _loc10_.getImageContainer(_loc4_);
         if(this.var_382 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_382 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_341);
            if(this.var_382 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_382,_loc4_);
         }
         this.var_382.offset = _loc8_;
         return this.var_382;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_79)
         {
            this.var_79 = this._structure.getCanvas(this._scale,this.var_742);
            if(!this.var_79)
            {
               return null;
            }
            this.var_2550 = new Point(0,this.var_79.height - int(this.var_79.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1480[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_731 || _loc10_ == AvatarAction.const_369;
         var _loc12_:int = param2.length - 1;
         _loc8_ = _loc12_;
         while(_loc8_ >= 0)
         {
            this.var_108 = param2[_loc8_] as AvatarImagePartContainer;
            if(!(param1 == 7 && (this.var_108.partType == "fc" || this.var_108.partType == "ey")))
            {
               this.var_1388 = this.var_108.bodyPartId;
               this.var_169 = this.var_108.partType;
               this.var_1804 = this.var_108.partId;
               this._frame = this.var_108.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_169 == "lh" || this.var_169 == "ls" || this.var_169 == "lc" || this.var_169 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_169 == "rh" || this.var_169 == "rs" || this.var_169 == "rc" || this.var_169 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_169 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_169 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_169 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_108.flippedPartType != this.var_169)
                     {
                        this.var_169 = this.var_108.flippedPartType;
                     }
                  }
               }
               this.var_1389 = this._scale + "_" + this.var_108.action.assetPartDefinition + "_" + this.var_169 + "_" + this.var_1804 + "_" + _loc5_ + "_" + this._frame;
               this.var_404 = this._assets.getAssetByName(this.var_1389) as BitmapDataAsset;
               if(this.var_404 == null)
               {
                  this.var_1389 = this._scale + "_std_" + this.var_169 + "_" + this.var_1804 + "_" + _loc5_ + "_0";
                  this.var_404 = this._assets.getAssetByName(this.var_1389) as BitmapDataAsset;
               }
               if(!(!this.var_404 || !this.var_404.content))
               {
                  if(this.var_108.paletteMapId > -1)
                  {
                     this.var_1803 = this._structure.renderManager.paletteManager.getPalette(this.var_108.paletteMapId);
                     if(this.var_1803 != null)
                     {
                        this.var_911 = this.var_404.content as BitmapData;
                        this.var_168 = new BitmapData(this.var_911.width,this.var_911.height);
                        this.var_2551 = this.var_1803.colorize(this.var_911.getPixels(this.var_911.rect));
                        this.var_168.setPixels(this.var_168.rect,this.var_2551);
                     }
                     else
                     {
                        this.var_168 = (this.var_404.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1388 == AvatarBodyPartType.const_206 || this.var_1388 == AvatarBodyPartType.const_1513 || this.var_1388 == AvatarBodyPartType.const_1399) && this.var_108.color != null)
                  {
                     _loc16_ = 0.7;
                     _loc17_ = this.var_108.color.colorTransform;
                  ...
                  else if(this.var_108.isColorable && this.var_108.color != null)
                  {
                     this.var_168.colorTransform(this.var_168.rect,this.var_108.color.colorTransform);
                  }
                  if(this.var_108.isBlendable)
                  {
                     this.var_168.colorTransform(this.var_168.rect,this.var_108.blendTransform);
                  }
                  this.var_912 = this.var_404.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_48)
                     {
                  ...
                  this.var_2549 = new ImageData(this.var_168,this.var_912,_loc7_);
                  this.var_910.push(this.var_2549);
               }
            }
            _loc8_--;
         }
         if(this.var_910.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_910,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2550.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_48)
            {
         ...
         _loc8_ = this.var_910.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_910.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
