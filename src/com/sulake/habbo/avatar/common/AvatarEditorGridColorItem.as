package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_830:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_748.width,this.var_748.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_748,this.var_748.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1027.width,this.var_1027.height,true,0);
            _loc5_ = this.var_1027.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_830.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_829.width,this.var_829.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_829,this.var_829.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_830)
            {
               switch(this.var_830.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_56:
                     _loc4_.style = HabboIconType.const_715;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_52:
                     _loc4_.style = HabboIconType.const_742;
                     _loc4_.visible = true;
               }
            }
            else
