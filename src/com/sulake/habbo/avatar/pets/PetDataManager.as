package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private var var_151:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_376.getValue(_loc4_) == null)
               {
                  this.var_376.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_461 == null)
         {
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_461.length > 0)
         {
            _loc1_ = this.var_461.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_376.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc4_:PetData = this.var_376.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_376.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_376.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_83)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1301.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_578.getValue(_loc6_) == null)
               {
                  ...
                  this.var_578.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_461.indexOf(param3) == -1)
                  {
                     this.var_461.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_578.getKeys())
         {
            _loc5_ = this.var_578.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_260.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
