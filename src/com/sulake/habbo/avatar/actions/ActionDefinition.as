package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1626:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_124 = new Dictionary();
         this.var_1626 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2295 = parseInt(param1.@precedence);
         this.var_2299 = String(param1.@activepartset);
         this.var_2297 = String(param1.@assetpartdefinition);
         this.var_2294 = String(param1.@lay);
         this.var_742 = String(param1.@geometrytype);
         this.var_2181 = Boolean(parseInt(param1.@main));
         this.var_2293 = Boolean(parseInt(param1.@method_11));
         this.var_2296 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "ObjectMouseData"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            {
               this.var_1626[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_124[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_693.getValue(param1) == null)
         {
            this.var_693.add(param1,new Map());
         }
         var _loc4_:Map = this.var_693.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_693.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1626[param1];
         if(_loc2_ == null)
         {
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_124[param1];
         if(_loc2_ != null)
         {
