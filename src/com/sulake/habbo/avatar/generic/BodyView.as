package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_552:String = "tab_boy";
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_61.controller.gender)
         {
            case FigureData.const_73:
               activateTab(this.const_552);
               inactivateTab(this.const_553);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_553);
               inactivateTab(this.const_552);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_552:
                  var_61.controller.gender = FigureData.const_73;
                  param1.stopPropagation();
                  break;
               case this.const_553:
                  var_61.controller.gender = FigureData.FEMALE;
                  param1.stopPropagation();
            }
         }
