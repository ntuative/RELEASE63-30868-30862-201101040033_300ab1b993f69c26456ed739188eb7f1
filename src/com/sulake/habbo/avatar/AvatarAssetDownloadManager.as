package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_389:AssetLoaderStruct;
      ...
      private const const_1843:int = 100;
      
      private const const_1409:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_389 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_879 = new Timer(this.const_1843,1);
         this.var_879.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_389)
         {
            this.var_389.addEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_389.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_389)
         {
            this.var_389.removeEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_389.removeEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1357.indexOf("?") > 0)
            {
               _loc2_ = this.var_1357 + "&retry=" + this.var_880;
            }
            else
            {
               _loc2_ = this.var_1357 + "?retry=" + this.var_880;
            ...
            this.var_389 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2435,this._assets);
      ...
      public function loadFigureSetData(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_461[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_461[_loc3_] = _loc6_;
            }
            this.var_878[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_878)
         {
            _loc7_ = true;
            _loc4_ = this.var_878[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_461[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_878[_loc3_];
         }
         while(_loc6_ < this.var_724.length)
         {
            _loc5_ = this.var_724[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_724.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_879.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_725.length > 0 && this.var_724.length < this.const_1409)
         {
            _loc1_ = this.var_725[0];
            _loc1_.startDownloading();
            this.var_724.push(this.var_725.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_725.indexOf(param1) == -1 && this.var_724.indexOf(param1) == -1)
         {
