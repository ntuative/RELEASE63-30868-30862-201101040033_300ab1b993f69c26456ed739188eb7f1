package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1178:IWindowContainer;
      
      public static var var_1439:IWindowContainer;
      
      public static var var_1910:int = 6710886;
      ...
      private var var_441:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_440:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1000 = [];
         this.var_1255 = [AvatarEditorFigureCategory.const_713,AvatarEditorFigureCategory.const_42,AvatarEditorFigureCategory.const_206,AvatarEditorFigureCategory.const_778,AvatarEditorFigureCategory.const_1006,AvatarEditorFigureCategory.const_95];
         super();
         ...
         if(var_1178 == null)
         {
            ...
            var_1178 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1439 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1439 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_364 = new Timer(1000);
         this.var_364.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1255;
         }
         for each(_loc6_ in param4)
         {
            this.var_1000.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_364.stop();
            this.var_364.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_364 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1255);
         }
         if(param1.length != this.var_1000.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1000.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2125 = this.canChangeOutfit();
            this.var_364.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_441 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_441.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_441.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1000.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_441.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_441.numSelectables)
               {
                  this.var_441.getSelectableAt(_loc6_).x = this.var_441.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1255;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1542 == AvatarEditorSideCategory.const_95 || this.var_2126))
         {
         ...
         this.setViewToCategory(this.var_312);
      }
      ...
      {
         if(this.var_1542 == AvatarEditorSideCategory.const_95)
         {
            this.var_2126 = false;
            this.setSideContent(AvatarEditorSideCategory.const_678);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_678:
               break;
            case AvatarEditorSideCategory.const_443:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_443);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_312 = param1;
         this.var_441.setSelected(this.var_441.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_440)
         {
            ...
            this.var_440 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_440.procedure = this.stripClubDialogEventProc;
            this.var_440.center();
         }
         else
         {
