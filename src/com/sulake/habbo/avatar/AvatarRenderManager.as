package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1845:String = "hd-99999-99999";
      ...
      private var var_331:PetDataManager;
      
      private var var_729:PaletteManager;
      
      private var var_520:String;
      
      private var var_283:Map;
      
      private var var_208:AvatarAssetDownloadManager;
      
      private var var_1747:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_520 = RenderMode.const_1318;
         ...
         _loc4_.method_9(param3.getAssetByName("HabboAvatarPartSets").content as XML);
         ...
         this.var_96.add(AvatarType.const_112,_loc4_);
         ...
         _loc4_.method_9(param3.getAssetByName("HabboAvatarPetPartSets").content as XML);
         ...
         this.var_96.add(AvatarType.const_65,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_331 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_729 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_331.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_96 != null)
         {
            for each(_loc1_ in this.var_96.getValues())
            {
               _loc1_.dispose();
            }
            this.var_96.dispose();
         ...
         if(this.var_208)
         {
            this.var_208.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_331.init();
         this.var_729.init();
         _loc2_ = this.var_96.getValue(AvatarType.const_112) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_96.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_96.getValue(AvatarType.const_112) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_208 == null)
               {
                  ...
                  this.var_208 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_208.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_849)
         {
            if(this.var_2453 && this.var_2451 && this.var_2452)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_208.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_208.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_96.getValue(AvatarType.const_112) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_208.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1747)
         {
            this.var_1747 = new AvatarFigureContainer(this.const_1845);
         }
         this.var_208.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1747,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_283 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_283.getKeys())
         {
            _loc4_ = this.var_283.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1489)
         {
            _loc6_ = !this.var_331.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_331.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_96.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_283.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_331.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_96.getValue(AvatarType.const_65);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_283.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_283.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_96.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_96.getValue(AvatarType.const_112) as AvatarStructure;
      ...
      {
         return this.var_331 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_65:
               _loc3_ = this.var_96.getValue(AvatarType.const_65) as AvatarStructure;
               break;
            default:
