package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1842:Number = 1.0;
      
      private var var_1844:Number = 1.0;
      
      private var var_1843:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1083:Map;
      
      private var var_2408:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_1705 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2406 = parseInt(_loc2_,16);
         this.var_2407 = parseInt(_loc3_,16);
         ...
         this.var_1623 = new ColorTransform(this.var_1842,this.var_1844,this.var_1843,this._alphaMultiplier);
         this.var_1083 = this.generatePaletteMapForGrayscale(this.var_2407,this.var_2406);
      }
      ...
      {
         return this.var_1083.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1083.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1083.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1083.getValue("alphas") as Array;
      }
