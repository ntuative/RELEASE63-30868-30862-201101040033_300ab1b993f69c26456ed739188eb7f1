package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1143:String = "Default";
      
      private static const const_1142:int = 2;
      
      private static const const_1144:String = AvatarSetType.const_33;
      ...
      protected var var_538:AvatarFigureContainer;
      
      protected var var_509:IAvatarDataContainer;
      
      protected var var_292:Array;
      
      protected var var_40:BitmapData;
      
      private var var_869:IActiveActionData;
      ...
      protected var var_1183:Boolean = false;
      ...
      private var var_1997:String = null;
      
      private var var_1999:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1144,const_1142);
         this.var_292 = new Array();
         this.var_869 = new ActiveActionData(AvatarAction.const_318);
         this.var_869.definition = this._structure.getActionDefinition(const_1143);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_702)
         {
            ...
            if(this.var_640)
            {
               for each(_loc2_ in this.var_640)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_538,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1492;
         if(param2 < AvatarDirectionAngle.const_966)
         {
            param2 = AvatarDirectionAngle.const_261 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_261)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_42 || param1 == AvatarSetType.const_33)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_534,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_264.length == 1 && this.var_84 == this.var_1925)
         {
            return this.var_84 + this.var_428 + this.var_534 % 4;
         }
         if(this.var_264.length == 2)
         {
            for each(_loc1_ in this.var_264)
            {
               ...
               {
                  return this.var_84 + this.var_428 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_534 % 11;
                  return this.var_84 + "_" + this.var_1925 + this.var_428 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_1998 || param2 != this.var_1997 || param1 != this.var_1999)
         {
            this.var_1998 = param3;
            this.var_1997 = param2;
            this.var_1999 = param1;
            this.var_1491 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(_loc3_ != null)
         {
            if(this.getFullImage(_loc3_))
            {
               ...
               this.var_40 = this.getFullImage(_loc3_) as BitmapData;
               this.var_1183 = true;
               return this.var_40;
            }
         }
         var _loc4_:AvatarImageCache = this.getCache();
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_257.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1183 || this.var_40 == null || (this.var_40.width != _loc5_.width || this.var_40.height != _loc5_.height))
         {
            if(this.var_40 != null && !this.var_1183)
            {
               this.var_40.dispose();
            }
            this.var_40 = new BitmapData(_loc5_.width,_loc5_.height,true,16777215);
            this.var_1183 = false;
         }
         var _loc6_:Array = this.getBodyParts(param1,this.var_257.definition.geometryType,this.var_84);
         this.var_40.lock();
         this.var_40.fillRect(this.var_40.rect,16777215);
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_534);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               _loc10_ = _loc9_.image;
               _loc11_ = _loc9_.regPoint.clone();
               this.var_40.copyPixels(_loc10_,_loc10_.rect,_loc11_.add(_loc7_),null,null,true);
            }
            _loc12_--;
         }
         this.var_40.unlock();
         ...
         if(this.var_509 != null)
         {
            ...
            {
               _loc13_ = this.convertToGrayscale(this.var_40);
               if(this.var_40)
               {
                  this.var_40.dispose();
               }
               this.var_40 = _loc13_;
               this.var_40.paletteMap(this.var_40,this.var_40.rect,new Point(0,0),this.var_509.reds,[],[]);
            }
            else
            {
               this.var_40.copyChannel(this.var_40,this.var_40.rect,new Point(0,0),2,8);
            }
         }
         if(_loc3_ != null)
         {
            this.cacheFullImage(_loc3_,this.var_40.clone());
         }
         if(this.var_40 && param2)
         {
            return this.var_40.clone();
         }
         return this.var_40;
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_257.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_257.definition.geometryType,this.var_84);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_534);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_292.push(new ActiveActionData(param1,param2,this.var_534));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_257 = this.var_869;
         this.var_257.definition = this.var_869.definition;
         this.resetBodyPartCache(this.var_869);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_264)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_428 = "";
         this.var_264 = this._structure.sortActions(this.var_292);
         if(this.var_264 == null)
         {
            this.var_693 = new Array(0,0,0);
            if(this.var_1224 != "")
            {
               _loc1_ = true;
               this.var_1224 = "";
         ...
         {
            this.var_693 = this._structure.getCanvasOffsets(this.var_264,this._scale,this.var_84);
            for each(_loc4_ in this.var_264)
            {
               this.var_428 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_291)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1225 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1225 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1224 != this.var_428)
            {
               _loc1_ = true;
               this.var_1224 = this.var_428;
            }
         }
         this.var_1223 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_264)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_868 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_180 = this.var_180.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1492 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_289 || _loc1_.actionType == AvatarAction.const_202 || _loc1_.actionType == AvatarAction.const_369)
               {
                  this.var_868 = true;
               }
            }
