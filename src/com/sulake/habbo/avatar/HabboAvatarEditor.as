package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1214:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1215:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1062:AvatarEditorHandler;
      ...
      private var var_857:IFigureData;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_470)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init() : void
      {
         ...
         if(!this.var_174)
         {
            ...
            _loc1_.loadAvatarData(const_1214,FigureData.const_73);
            _loc2_.loadAvatarData(const_1215,FigureData.FEMALE);
            this.var_92 = new Map();
            this.var_470 = new Map();
            this.var_92.add(AvatarEditorFigureCategory.const_713,new BodyModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_42,new HeadModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_206,new TorsoModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_778,new LegsModel(this));
            this.var_92.add(AvatarEditorFigureCategory.const_1006,new HotLooksModel(this));
            this.var_470.add(AvatarEditorSideCategory.const_95,new WardrobeModel(this));
            this.var_470.add(AvatarEditorSideCategory.const_443,new ClubPromoModel(this));
            this.var_174 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_857.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_857.getPalette(param1);
      }
      
      public function method_8(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         if(!this.var_174)
         {
            this.init();
         ...
         else
         {
            if(this.var_237 == null)
            {
               this.var_237 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_237.addChild(this._view.window);
               if(param5)
               {
                  this.var_237.center();
               }
            ...
            this.var_237.visible = !this.var_237.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_713);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_470.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_471 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_857 = this.var_471.getFigureData(AvatarType.const_112);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1062 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_585[this.var_797];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1316 != null)
         {
            ...
            this.var_1316.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1657;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1063 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1213)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1439.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_471.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_471.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1178.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1498)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1063 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1178.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1063 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_470.getValue(AvatarEditorSideCategory.const_95);
      }
