package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_538 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_538.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1334 = this.var_1333;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_42)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1334);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_257.definition.geometryType);
         if(this.var_40 == null || _loc4_ != null && (this.var_40.width != _loc4_.width || this.var_40.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_257.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
            this.var_40 = new BitmapData(_loc4_.width,_loc4_.height,true,16777215);
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_534);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_538,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1334 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_83)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_534);
                  _loc20_ = this.var_84;
                  _loc21_ = 1;
                  switch(this.var_84)
                  {
               ...
               this.var_40.copyPixels(_loc10_,_loc10_.rect,_loc11_.add(_loc6_),null,null,true);
            }
            _loc7_--;
         }
         this.var_40.unlock();
         ...
         if(this.var_509 != null)
         {
            ...
            {
               _loc23_ = this.convertToGrayscale(this.var_40);
               if(this.var_40)
               {
                  this.var_40.dispose();
               }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_534);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_538,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_83)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_534);
                  _loc21_ = this.var_84;
                  _loc22_ = 1;
                  switch(this.var_84)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_428 = this.var_428 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_869);
         this.getCache().resetBodyPartCache(this.var_869);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1332 = this._structure.sortActions(this.var_292);
         ...
         {
            this.var_693 = this._structure.getCanvasOffsets(this.var_1332,this._scale,this.var_84);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1332)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_202)
               {
                  this.var_868 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_289)
               {
                  this.var_868 = true;
               }
            }
