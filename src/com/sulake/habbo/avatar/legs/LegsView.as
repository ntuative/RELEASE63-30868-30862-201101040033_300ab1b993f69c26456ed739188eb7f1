   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.const_214,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.const_209,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_61 && var_130 == "")
         {
            var_61.switchCategory(FigureData.TROUSERS);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_shoes":
                  ...
                  break;
               case "tab_belts":
                  this.switchCategory(FigureData.const_209);
            }
         }
