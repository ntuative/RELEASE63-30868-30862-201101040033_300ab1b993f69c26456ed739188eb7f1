   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.const_221,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.const_171,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_61,FigureData.const_228,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_61 && var_130 == "")
         {
            var_61.switchCategory(FigureData.const_171);
         }
      }
