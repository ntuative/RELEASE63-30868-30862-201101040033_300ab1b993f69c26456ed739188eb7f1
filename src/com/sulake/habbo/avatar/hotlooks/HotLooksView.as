package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_61:HotLooksModel;
      ...
      public function init() : void
      {
         ...
         this.var_524 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_524.numGridItems > 0)
         {
            this.var_524.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_61 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_524.removeGridItems();
         for each(_loc2_ in this.var_61.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_524.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_524.getGridItemIndex(param2.parent);
            this.var_61.selectHotLook(_loc3_);
         }
      }
