package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1729:String = "hot_looks";
      
      public static const const_1644:String = "my_looks";
      ...
      {
         super(param1);
         this.var_502 = new Dictionary();
         this.var_502["null"] = new Array();
         this.var_502["null"] = new Array();
         this.var_502["undefined.index"] = 0;
         this.var_502["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_502["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_502[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
