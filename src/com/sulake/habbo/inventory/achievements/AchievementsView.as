package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_61:AchievementsModel;
      
      private var var_1141:Dictionary;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_405 = new Timer(1000,1);
         this.var_405.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_368.events.addEventListener(BadgeImageReadyEvent.const_126,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_405)
            {
               this.var_405.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_405.reset();
               this.var_405 = null;
            }
            this._disposed = true;
      ...
      public function updateList() : void
      {
         ...
         var _loc1_:Array = this.var_61.getAchievements();
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_405.running);
         this.var_1141[param1.badgeId] = param1.badgeImage;
         if(!this.var_405.running)
         {
            this.var_405.start();
         }
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1141[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_368.getBadgeImage(param2.badgeId);
            this.var_1141[param2.badgeId] = _loc4_;
         }
