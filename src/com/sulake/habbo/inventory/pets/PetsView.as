package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_323:PetsGridItem;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_323);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_580.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_487.removeGridItem(_loc2_.window);
         if(this.var_323 == _loc2_)
         {
            this.var_323 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_580 == null || this.var_580.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_580.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_580.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_580.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_580.reset();
         var _loc1_:Map = this.var_61.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_323.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_61.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_57)
         {
            ...
            {
               case "tab_floor":
                  this.var_61.switchCategory(FurniModel.const_39);
                  break;
               case "tab_wall":
                  this.var_61.switchCategory(FurniModel.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_323 != null)
         {
            this.var_323.setSelected(false);
         }
         this.var_323 = param1;
         if(this.var_323 != null)
         {
            this.var_323.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_61.roomSession != null)
         {
            _loc8_ = this.var_61.roomSession.arePetsAllowed;
            _loc9_ = this.var_61.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
