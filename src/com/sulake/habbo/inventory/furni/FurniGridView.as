package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_2745:XML;
      
      private var var_603:Object;
      ...
      {
         var _loc3_:* = null;
         var _loc1_:Array = this.var_61.getCategoryContent(this._category);
         var _loc2_:int = 0;
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_40)
         {
            ...
            this.var_61.toggleItemSelection(this._category,this.var_487.getGridItemIndex(param1.window));
            this.var_603 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_603 != null && this.var_603 == param2 && !this.var_61.isTradingOpen)
         {
            _loc3_ = this.var_61.requestSelectedFurniPlacement(true);
            if(_loc3_)
            {
               this.var_603 = null;
            }
         ...
         else if(param1.type == WindowMouseEvent.const_298)
         {
            this.var_61.requestCurrentActionOnSelection();
            this.var_603 = null;
         }
      }
   }
