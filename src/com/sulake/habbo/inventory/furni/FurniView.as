package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1566:int = 120;
      ...
      private var var_61:FurniModel;
      
      private var var_751:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_448.add(FurniModel.const_39,new FurniGridView(this.var_61,FurniModel.const_39,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_448.add(FurniModel.const_45,new FurniGridView(this.var_61,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModel.const_39);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_61.isTradingOpen;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModel.const_45:
               ...
               this.var_369 = FurniModel.const_45;
               break;
            case FurniModel.const_39:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_369 = FurniModel.const_39;
               break;
            case FurniModel.const_344:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_369 = FurniModel.const_344;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_61.furniCategorySwitch();
         this.showCategoryGrid(this.var_369);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_448.getValue(this.var_369);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_61.getCategoryContent(this.var_369);
         if(!this.var_61.isListInited())
         {
         ...
         {
            _loc2_ = this.const_1569;
         }
         if(this.var_2210 == _loc2_)
         {
            return;
         }
         this.var_2210 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_39,FurniModel.const_45];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_448.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_448.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_448.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_61.getSelectedItemIndex();
         _loc4_ = this.var_61.getGroupItemInIndex(_loc3_,this.var_369);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_357)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_150)
               {
         ...
         var _loc12_:Boolean = this.var_61.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_61.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_61.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_751 && this.var_751.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1566)
         {
            _loc3_ = this.const_1566;
         }
      ...
      {
         var _loc3_:GroupItem = this.var_61.getGroupItemInIndex(this.var_61.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_61.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_61.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_61.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_61.requestCatalogOpen();
                  break;
               default:
                  this.var_61.cancelFurniInMover();
            }
         }
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_344);
            }
         }
      }
   }
