package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_61:BadgesModel;
      
      private var var_1071:IItemGridWindow;
      
      private var var_1070:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1071 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1071.procedure = this.inactiveGridEventProc;
         this.var_1070 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1070.procedure = this.activeGridEventProc;
      }
      ...
      private function updateListViews() : void
      {
         ...
         this.var_1071.removeGridItems();
         this.var_1070.removeGridItems();
         var _loc1_:Array = this.var_61.getBadges(0);
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               this.var_1071.addGridItem(_loc2_.window);
               _loc2_.window.procedure = this.inactiveGridEventProc;
            }
            _loc3_++;
         }
         var _loc4_:Array = this.var_61.getBadges(1);
         _loc3_ = 0;
         while(_loc3_ < _loc4_.length)
         {
            _loc2_ = _loc4_[_loc3_] as Badge;
            this.var_1070.addGridItem(_loc2_.window);
      ...
      private function updateActionView() : void
      {
         ...
         var _loc2_:Badge = this.var_61.getSelectedBadge();
         if(_loc2_ == null)
         {
            _loc1_.disable();
         ...
         else
         {
            ...
            this.setBadgeName(this.var_61.controller.localization.getBadgeName(_loc2_.type));
            this.setBadgeDescriptionText(this.var_61.controller.localization.getBadgeDesc(_loc2_.type));
            this.setBadgeDescriptionImage(_loc2_.iconImage);
            _loc3_ = this.var_61.getBadges(1);
            if(_loc3_ != null && _loc3_.length >= this.var_61.getMaxActiveCount() && !_loc2_.isInUse)
            {
               _loc1_.disable();
            }
            else
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_1071.getGridItemIndex(param1.window);
            _loc4_ = this.var_61.getBadgeFromInactive(_loc3_);
            if(_loc4_ != null)
            {
               this.var_61.setBadgeSelected(_loc4_.type);
            }
         }
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1070.getGridItemIndex(param1.window);
            _loc4_ = this.var_61.getBadgeFromActive(_loc3_);
            if(_loc4_ != null)
            {
               this.var_61.setBadgeSelected(_loc4_.type);
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "wearBadge_button":
                  _loc3_ = this.var_61.getSelectedBadge();
                  if(_loc3_ != null)
                  {
                     this.var_61.toggleBadgeWearing(_loc3_.type);
                  }
            }
         }
      }
