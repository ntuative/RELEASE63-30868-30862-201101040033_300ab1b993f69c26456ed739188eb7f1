package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1440:uint = 9;
      
      public static const const_167:uint = 0;
      ...
      public static const const_410:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_49.updateItemList(this.var_647);
         this.var_49.updateItemList(this.var_1232);
      ...
      public function close() : void
      {
         if(this.var_678)
         {
            if(this._state != const_167 && this._state != const_254)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_167;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_1088);
            this.var_678 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_646 + " OTHER: " + this.var_977);
         ...
         {
            case const_167:
               if(param1 == const_184 || param1 == const_254)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_49.alertPopup(TradingView.const_987);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_647)
            {
               this.var_646 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_977 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_647)
            {
               this.var_49.alertPopup(TradingView.const_952);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_265.length < const_1440)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_150)
            {
