package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_854:uint = 4284532064;
      
      private static const const_855:uint = 2577770;
      
      public static const const_948:int = 0;
      ...
      private var var_377:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_377 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_179)
            {
               this.var_179.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_179.stop();
               this.var_179 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1637 = this.createMinimizedWindow();
         }
         if(!this.var_2308)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_854) : uint(const_855);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_854) : uint(const_855);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_179 = new Timer(1000,3);
            this.var_179.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_179.reset();
         this.var_179.repeatCount = 3;
         this.var_179.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_179.currentCount));
         if(this.var_179.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_150)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_903)
            {
            ...
            this.var_377.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_519);
            this.var_377.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_377.hideDelayed();
         }
      }
