package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_17 != null)
         {
            this.var_17.events.removeEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_404,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_47.getValue(InventoryCategory.const_77));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_47.getValue(InventorySubCategory.const_293));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_47.getValue(InventoryCategory.const_748));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_47.getValue(InventoryCategory.const_271));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_47.getValue(InventoryCategory.const_349));
      }
      ...
      {
         return PetsModel(this.var_47.getValue(InventoryCategory.const_156));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_47.getValue(InventoryCategory.const_368) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_404,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_92:
               this.var_1148 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_404:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_368 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_17 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_47.add(InventoryCategory.const_368,_loc1_);
         ...
         this.var_47.add(InventoryCategory.const_748,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_368);
         this.var_47.add(InventoryCategory.const_349,_loc5_);
         ...
         this.var_47.add(InventorySubCategory.const_293,_loc6_);
         ...
         this.var_47.add(InventoryCategory.const_156,_loc8_);
         this.var_174 = true;
         if(this.var_2585)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_293:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_925.indexOf(param1) == -1)
            {
               this.var_925.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_925.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_925.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_925.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_920));
      }
