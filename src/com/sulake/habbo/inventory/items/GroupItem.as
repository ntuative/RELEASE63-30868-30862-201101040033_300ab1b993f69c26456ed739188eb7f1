package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_772:int = 0;
      
      protected var var_627:BitmapData;
      
      protected var var_2089:int;
      
      protected var var_1447:Boolean;
      
      protected var var_1931:Boolean;
      
      protected var var_2670:BitmapData;
      
      private const const_1830:int = 8947848;
      
      private const const_1829:int = 13421772;
      ...
      public function initImage() : void
      {
         ...
         if(this._mainCategory == FurniModel.const_39)
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1407));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1930);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_772 = _loc1_.id;
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_627)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(this.var_1931 && this.getRecyclableCount() > 0)
            {
