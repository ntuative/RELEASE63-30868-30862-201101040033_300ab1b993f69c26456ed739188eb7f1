package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1043:IRoomWidgetFactory = null;
      
      private var var_368:ISessionDataManager = null;
      
      private var var_17:IRoomSessionManager = null;
      
      private var var_471:IAvatarRenderManager = null;
      ...
      private var var_1144:IHabboHelp = null;
      ...
      private var var_1614:Boolean = true;
      
      private var var_689:Array;
      
      private var var_200:IToolTipWindow;
      
      private var var_2262:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_315,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_430,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_624,this.onRoomContentLoaded);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_455.length)
            {
               _loc6_ = this.var_455.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_315,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_430,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_624,this.onRoomContentLoaded);
         }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_29 != null)
         {
            this.var_689 = this._roomEngine.loadRoomResources(this.var_29.roomResources);
            if(this.var_689.length > 0)
            {
               this.var_1614 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_99));
            }
         }
         if(this.var_286 != null && this.var_29.state == RoomSessionEvent.const_252)
         {
            this.var_1616 = !this.var_286.showInterstitial();
         }
      ...
      {
         if(this.var_689 == null || this.var_689.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_689.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_689.splice(_loc2_,1);
         }
         if(this.var_689.length == 0)
         {
            this.var_1614 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1043.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(!this.var_455.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_691.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_691.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_690.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_690.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_691.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_690.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_796:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_326,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(this.var_923 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_29.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_340)
                  {
                     this.var_923.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_280:
               switch(_loc3_)
               {
               ...
               break;
            case RoomEngineObjectEvent.const_652:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                  case RoomObjectCategoryEnum.const_27:
            ...
            case RoomEngineObjectEvent.const_539:
               ...
               break;
            case RoomEngineObjectEvent.const_711:
               if(!this.var_29.isRoomController && !this.var_368.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_136:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_637,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
            ...
            case RoomEngineObjectEvent.const_118:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_768,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_502:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_102,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_506:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1010,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc5_:int = 0;
         if(this.var_273.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_591);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_631);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_664);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_29.roomId,this.var_29.roomCategory,RoomVariableEnum.const_606);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_298,this.canvasMouseHandler);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_231,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2262);
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_298:
               _loc3_ = "null";
               break;
            ...
            case WindowMouseEvent.const_231:
               _loc3_ = "null";
               break;
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_273[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_29.roomId,this.var_29.roomCategory,this.var_273[0],_loc2_.width,_loc2_.height);
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1615) / 1000);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < this.var_455.length)
         {
            _loc2_ = this.var_455.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         if(this.var_17 != null && this.var_29 != null && this.var_1616 && this.var_1614)
         {
            this.var_17.startSession(this.var_29);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_306));
         }
      }
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_521:
               ...
               this.var_200 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_376,WindowStyle.const_781,WindowParam.const_88) as IToolTipWindow;
