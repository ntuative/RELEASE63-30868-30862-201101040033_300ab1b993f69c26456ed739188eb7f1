package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_899:Map = null;
      
      private var _connection:IConnection = null;
      
      private var var_1112:Number = 0.0;
      
      private var var_738:Point = null;
      
      private var var_489:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_489 = new Vector3d();
         super();
      ...
      public function dispose() : void
      {
         ...
         if(this.var_399 != null)
         {
            ...
            {
               _loc2_ = this.var_399.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_398.length)
            {
               _loc2_ = this.var_398.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_638,RoomWidgetChatSelectAvatarMessage.const_690];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_638:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_690:
      ...
      {
         return [RoomSessionChatEvent.const_176];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_176:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_398.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_399.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_899.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_223:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.const_83,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_223)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_398.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_399.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_899.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1112 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1112);
            }
            if(this.var_738 == null)
            {
               ...
               this.var_489.y = 0;
               this.var_489.z = 0;
               this.var_738 = _loc4_.getScreenPoint(this.var_489);
               this.var_1112 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_489.x = 0;
            this.var_489.y = 0;
            this.var_489.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_489);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_738.x || _loc8_.y != this.var_738.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_738,_loc5_));
