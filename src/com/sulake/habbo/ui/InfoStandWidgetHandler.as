package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_126,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_126,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_723.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_723.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_352);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_818);
         _loc1_.push(RoomWidgetUserActionMessage.const_746);
         _loc1_.push(RoomWidgetUserActionMessage.const_752);
         _loc1_.push(RoomWidgetFurniActionMessage.const_300);
         _loc1_.push(RoomWidgetFurniActionMessage.const_750);
         _loc1_.push(RoomWidgetFurniActionMessage.const_799);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_620);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_749);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1347);
         _loc1_.push(RoomWidgetPetCommandMessage.const_821);
         _loc1_.push(RoomWidgetPetCommandMessage.const_616);
         _loc1_.push(RoomWidgetUserActionMessage.const_528);
         _loc1_.push(RoomWidgetUserActionMessage.const_371);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_813);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_446)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_371 || param1.type == RoomWidgetUserActionMessage.const_528 || param1.type == RoomWidgetUserActionMessage.const_532)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_352:
            ...
            case RoomWidgetUserActionMessage.const_605:
               ...
               break;
            case RoomWidgetUserActionMessage.const_818:
            ...
            case RoomWidgetUserActionMessage.const_371:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_620:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_749:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_595);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_365);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1039);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1027);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_223)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_340)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1061)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_511);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_183)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_225)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_657);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1333;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1016;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_954;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1531);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_124];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_124:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_723.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_48);
            this.var_723.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_657);
