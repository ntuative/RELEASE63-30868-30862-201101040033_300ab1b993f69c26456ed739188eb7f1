package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1496:IWindowContainer;
      ...
      private var var_974:IContainerButtonWindow;
      
      private var var_975:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_88.getXmlWindow("ude_help"));
         this.var_1496 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_975 = this.var_1496.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_975)
         {
            this.var_975.procedure = this.onButtonClick;
         }
         this.var_974 = this.var_1496.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_974)
         {
            this.var_974.procedure = this.onButtonClick;
         }
      ...
      private function initLocalizations() : void
      {
         ...
         this._localizations = [];
         var _loc1_:int = 1;
         while(this.var_88.localization.getLocalization("wiredfurni.help." + _loc1_ + ".title"))
         {
            _loc2_ = this.var_88.localization.getLocalization("wiredfurni.help." + _loc1_ + ".title");
            _loc3_ = this.var_88.localization.getLocalization("wiredfurni.help." + _loc1_ + ".img");
            _loc4_ = this.var_88.localization.getLocalization("wiredfurni.help." + _loc1_ + ".text");
      ...
      {
         if(!param1 || !this.var_88 || !this.var_88.assets)
         {
            return;
         }
         var _loc2_:BitmapDataAsset = this.var_88.assets.getAssetByName(param1) as BitmapDataAsset;
         if(_loc2_ == null)
         {
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         var _loc2_:String = this.var_88.configuration.getKey("image.library.catalogue.url");
         var _loc3_:* = _loc2_ + param1 + ".gif";
         Logger.log("[ProductViewCatalogWidget] Retrieve Product Preview Asset: " + _loc3_);
         var _loc4_:URLRequest = new URLRequest(_loc3_);
         var _loc5_:AssetLoaderStruct = this.var_88.assets.loadAssetFromFile(param1,_loc4_,"image/gif");
         if(!_loc5_)
         {
            return;
         }
