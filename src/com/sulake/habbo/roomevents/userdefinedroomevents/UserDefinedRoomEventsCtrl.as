package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_88:HabboUserDefinedRoomEvents;
      ...
      private var var_730:RoomObjectHightLighter;
      
      private var var_158:UserDefinedRoomEventsHelp;
      
      private var var_1100:SliderWindowController;
      ...
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         ...
         super();
         this.var_88 = param1;
         this.var_730 = new RoomObjectHightLighter(param1);
         this.var_158 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_245[param1])
         {
            delete this.var_245[param1];
            this.var_730.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_58.furniLimit)
         {
            this.var_245[param1] = param2;
            this.var_730.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_88.getXmlWindow("ude_main"));
         ...
         this.var_1100 = new SliderWindowController(this.var_88,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_88.assets,0,20,1);
         this.var_1100.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1100.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_88.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_88.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_730.hideAll(this.var_245);
         }
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_58 as TriggerDefinition != null)
         {
            this.var_88.send(new UpdateTriggerMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_58 as ActionDefinition != null)
         {
            this.var_88.send(new UpdateActionMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_58 as ConditionDefinition != null)
         {
            this.var_88.send(new UpdateConditionMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1100.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_158.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.send(new ApplySnapshotMessageComposer(this.var_58.id));
      }
      ...
      {
         var _loc2_:IFurnitureData = this.var_88.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         this.var_88.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_88.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_88.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         this.var_88.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_88.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_88.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_88.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_88);
         }
         return _loc5_;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         this.var_88.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_88.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
   }
}
