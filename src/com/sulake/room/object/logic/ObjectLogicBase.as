package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_317:IRoomObjectController;
      ...
      {
         if(this.var_317 == param1)
         {
            return;
         }
         if(this.var_317 != null)
         {
            this.var_317.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_317 = param1;
            this.var_317.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_317 != null)
            {
               this.var_317.setLocation(param1.loc);
               this.var_317.setDirection(param1.dir);
            }
         }
      }
   }
