package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2732:IRoomContentLoader;
      
      private var var_542:IRoomObjectFactory = null;
      
      private var var_435:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_978:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_430,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_624,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_102.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_102.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_542 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_542 == null || this.var_435 == null)
         {
            return;
         }
         this._state = const_1397;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_543.indexOf(_loc5_) < 0)
            {
               this.var_45.loadObjectContent(_loc5_,events);
               this.var_543.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function addObjectUpdateCategory(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_102.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_102.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         if(this.var_102.getValue(param1) != null)
         {
            return null;
         }
         var _loc3_:RoomInstance = new RoomInstance(param1,this);
         this.var_102.add(String(param1),_loc3_);
      ...
      {
         return this.var_102.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_102.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_435.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_435.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_542.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_542 != null)
         {
            return this.var_542.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_584)
         {
            return;
         }
         if(this.var_45 == null)
         {
            this._state = const_584;
            return;
         }
         if(this.var_45.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_543.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_543.splice(_loc2_,1);
            }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_45 == null || this.var_435 == null)
         {
            return;
         }
         ...
         var _loc5_:* = null;
         var _loc6_:int = this.var_102.length - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.var_102.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = this.var_102.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_435.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_435.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_542.createRoomObjectLogic(_loc18_);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_102.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_102.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
