package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1560:int = 50;
      ...
      private var var_554:RoomObjectCache;
      ...
      private var var_2158:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_230 = new Sprite();
         this.var_230.mouseEnabled = false;
         this.var_52 = new Sprite();
         this.var_52.name = "canvas";
         this.var_52.mouseEnabled = false;
         this.var_230.addChild(this.var_52);
         this.var_52.mouseEnabled = true;
         this.var_52.doubleClickEnabled = true;
         this.var_52.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_52.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         this._geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         this.var_231 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_554 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_445.x -= param1 - this.var_556;
         this.var_556 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_445.y -= param1 - this.var_557;
         this.var_557 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_816 = true;
            if(this.var_119 != null && !this.var_230.contains(this.var_119))
            {
               this.var_230.addChild(this.var_119);
               this.var_52.mask = this.var_119;
            }
         }
         else if(!param1 && this.var_816)
         {
            this.var_816 = false;
            if(this.var_119 != null && this.var_230.contains(this.var_119))
            {
               this.var_230.removeChild(this.var_119);
               this.var_52.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_230.numChildren > 0)
            {
               this.var_230.removeChildAt(0);
            }
            this.var_230 = null;
         }
         this.var_52 = null;
      ...
      {
         this.var_554.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_662 != this.var_2159 || this._ht != this.var_2162)
         {
            _loc9_ = true;
         }
         if(this.var_52.x != this.var_556 || this.var_52.y != this.var_557)
         {
            this.var_52.x = this.var_556;
            this.var_52.y = this.var_557;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_444.sortOn("z",0 | 0);
         if(_loc5_ < this.var_444.length)
         {
            this.var_444.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_444[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2159 = this.var_662;
         this.var_2162 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_554.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_554.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_556;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_557;
                  if(_loc19_ < this.var_662 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_444.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_556;
                     _loc17_.y = _loc20_ - this.var_557;
      ...
      {
         if(param1 < 0 || param1 >= this.var_52.numChildren)
         {
            return null;
         }
         return this.var_52.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_52.numChildren)
         {
            this.var_52.addChild(_loc3_);
         }
         else
         {
            this.var_52.addChildAt(_loc3_,param2);
         }
         ++this.var_661;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         var _loc6_:* = null;
         if(param1 >= this.var_52.numChildren)
         {
            this.createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = this.var_52.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_52.removeChildAt(param1);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_661 || this.var_661 == 0)
         {
            _loc5_ = this.var_52.numChildren - 1;
            while(_loc5_ >= param1)
            {
               _loc3_ = this.var_52.getChildAt(_loc5_);
      ...
      {
         if(param1 < 0 || param1 >= this.var_444.length)
         {
            return null;
         }
         return this.var_444[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_231.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_231.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_231.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_231.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_556;
         param2 -= this.var_557;
         this.var_445.x = param1;
         this.var_445.y = param2;
         if(this.var_1003 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1555;
         }
         this.var_1555 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1003;
         return this.var_1555;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_662 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1556,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseClickHits(param1:Number, param2:Number, param3:Boolean, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         var _loc13_:* = [];
         var _loc14_:int = 0;
         _loc14_ = this.var_661 - 1;
         while(_loc14_ >= 0)
         {
            _loc10_ = this.var_52.getChildAt(_loc14_) as ExtendedSprite;
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_558.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_558.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2160 || param2 != this.var_2158)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_558.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_558.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         ...
         {
            this.var_314.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_314 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_314.getKey(_loc1_);
            _loc3_ = this.var_314.getWithIndex(_loc1_);
      ...
      public function update() : void
      {
         if(this.var_1003 == 0)
         {
            this.checkMouseHits(this.var_445.x,this.var_445.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1003 = 0;
         ++this.var_1556;
      }
