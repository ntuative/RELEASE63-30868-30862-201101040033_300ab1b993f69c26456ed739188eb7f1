package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1401:int = 128;
      
      private var var_1400:Boolean = false;
      
      private var var_2720:Point;
      ...
      {
         if(param1 != this.var_1819 || param2 != this.var_1818)
         {
      ...
      {
         if(this.var_1401 > 255 || bitmapData == null)
         {
            return false;
         }
